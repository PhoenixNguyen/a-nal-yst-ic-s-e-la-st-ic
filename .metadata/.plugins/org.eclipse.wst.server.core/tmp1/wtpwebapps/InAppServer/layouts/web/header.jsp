	...
	<div id="account-header">
		<ul class="nav">
				...
				<li class="ui-button">
					...
					<div class="sub-nav chat-bubble" align="left">
						<ul>
							...
							<div class="clear"></div>
							<li><a href="<%= request.getContextPath()%>/protected/sdk-server.html">Cấu hình</a></li>
			...
			<li>
				...
				<a href="<%= request.getContextPath()%>/protected/sdk-server.html"><img src="<%=request.getContextPath()%>/images/door-open-in.png"
