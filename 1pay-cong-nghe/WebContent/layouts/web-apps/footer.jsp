		...
		<div class="layout_1000">
			<div class="foot_col">
				<ul>
					...
					<li><a href="<%=request.getContextPath() %>/dich-vu.html?n=iac" class="foot_link">SMS Plus Charging</a></li>
...
<div class="fix-bar">
	...
	<a href="ymsgr:sendim?help.1pay&m=Chào+bạn" style="color: #FFF"><img src="<%=request.getContextPath() %>/images/yahoo.png" style="vertical-align: bottom; margin-right: 5px;" width="16px"/><strong>Yahoo:</strong> hỗ trợ 2</a>
</div>
<!-- / Web Foot -->
<!-- 
