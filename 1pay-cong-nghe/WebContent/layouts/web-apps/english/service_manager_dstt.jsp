			...
			<div class="layout_1000">
            	...
            	<div class="row_sub">
                   ...
                   <li><a href="#">API Access</a></li>     
                        ...
                        <li><a href="manage_svr_doisoatthanhtoan.html" class="slc_link">Đối soát & thanh toán </a></li>
                        <li><a href="manage_svr_hopdongdientu.html">Hợp đồng điện tử</a></li>
	...
	$('#reservation').daterangepicker({ startDate: Date.today().moveToFirstDayOfMonth().add(6).days(), endDate: Date.today().moveToFirstDayOfMonth().add(13).days()});
                ...
                <div class="filter_row">
                  ...
                  <option>Tắt</option>
               	  ...
               	  <div class="product_slc_filter">
                  	<label class="product_lbl_filter">Providers:</label>
                  
                  <select class="product_filter_admin">   
                  <option>Tất cả</option>               	<option>Đã kích hoạt</option>
...
<label for="chck_direct" class="lbl_chcksub">															Direct charging</label>
			...
			<div>
														<input type="checkbox" title="nganluong" value="nganluong" name="provider" class="chck_filter" id="chck_nhomthecao">
                                                        <label for="chck_nhomthecao" class="lbl_chcksub_admin">Nhóm theo thẻ cào</label>
                       ...
                       <tbody>
                         <tr>
                          <td class="transhead" width="30">STT</td>
                           <td class="transhead" width="60"> Merchant</td><td  class="transhead" width="200">Tên sản phẩm</td>
                           <td  class="transhead" width="110">Charging</td>
                           <td class="transhead">Số giao dịch</td>
                           <td class="transhead" width="105">Số tiền (VND)</td>
                           <td class="transhead" width="85">Actions</td>
                         </tr>
                         <tr>
                       	   <td class="svr_data" align="center">1</td>
                           <td class="svr_data">CMN</td>
                           <td class="svr_data">Thiên địa quyết</td>
                            <td class="svr_data"><a class="card_normal" href="#" ></a><a class="sms_normal" href="#" ></a><a class="sub_normal" href="#" ></a></td>
                            <td class="svr_data" align="center">12</td>
                           <td class="svr_data" align="right">12.000.000</td>
                          <td class="svr_data"><a href="#" class="link_denghi" title="Đề nghị"></a> <a href="#" class="link_duyet" title="Duyệt"></a> <a href="#" class="link_thanhtoan" title="Thanh toán"></a> <a href="#" class="link_hoanthanh" title="Hoàn thành"></a> </td>
                         </tr>
                         
                         <tr>
                       	   <td class="svr_data" align="center">2</td>
                           <td class="svr_data">OUTT</td>
                           <td class="svr_data">Thiên địa quyết</td>
                            <td class="svr_data"><a class="card_normal" href="#" ></a><a class="sms_normal" href="#" ></a><a class="sub_normal" href="#" ></a></td>
                            <td class="svr_data" align="center">12</td>
                           <td class="svr_data" align="right">12.000.000</td>
                           <td class="svr_data"><a href="#" class="link_denghi"></a> <a href="#" class="link_duyet"></a> <a href="#" class="link_thanhtoan"></a> <a href="#" class="link_hoanthanh"></a> </td>
                         </tr>
                         
                         <tr>
                       	   <td class="svr_data" align="center">3</td>
                           <td class="svr_data">WASABI</td>
                           <td class="svr_data">Thiên địa quyết</td>
                            <td class="svr_data"><a class="card_normal" href="#" ></a><a class="sms_normal" href="#" ></a><a class="sub_normal" href="#" ></a></td>
                            <td class="svr_data" align="center">12</td>
                           <td class="svr_data" align="right">12.000.000</td>
