...
<div id="w_foot">
		...
		<div class="layout_1000">
			...
			<div class="foot_col">
				<%-- <ul>
					...
					<li><a href="http://docs.1pay.vn/doku.php?id=start&do=index" class="foot_link">Tài liệu APIs</a></li>
	...
	<!-- / Foot Menu -->
	<div id="foot_info">
		<div class="info_holder">Copyright © 2013 1Pay Co., Ltd. All rights reserved.</div>
	</div>
</div>
<div class="fix-bar">
	...
	<img src="<%=request.getContextPath() %>/images/phone.png" style="vertical-align: bottom; margin-right: 5px;" width="16px"/><strong>Hotline:</strong> <a href="tel:84964222628" style="color: #FFF">(+84) 964222628</a> - <a href="tel:84904253125" style="color: #FFF">(+84) 90 4253125</a> 
	<a href="skype:smartvietnam?chat" style="color: #FFF"><img src="<%=request.getContextPath() %>/images/skype.png" style="vertical-align: bottom; margin-right: 5px;" width="16px"/><strong>Skype:</strong> Hỗ trợ 1</a>
	<a href="skype:ngoc_lan_xanh26?chat" style="color: #FFF"><img src="<%=request.getContextPath() %>/images/skype.png" style="vertical-align: bottom; margin-right: 5px;" width="16px"/><strong>Skype:</strong> Hỗ trợ 2</a> 
	<a href="ymsgr:sendim?ngoc_lan_xanh26&m=Chào+bạn" style="color: #FFF"><img src="<%=request.getContextPath() %>/images/yahoo.png" style="vertical-align: bottom; margin-right: 5px;" width="16px"/><strong>Yahoo:</strong> hỗ trợ 3</a>
</div>
<!-- / Web Foot -->
<!-- 
