				...
				<li class="ui-button">
					...
					<div class="sub-nav chat-bubble" align="left">
						<ul>
							...
							<%} if(account.checkRole(Account.ACCOUNT_STAFF_ROLE) && account.checkRoles(new String[]{Account.ACCOUNT_MARKETING_MANAGER_ROLE, Account.ACCOUNT_MERCHANT_MANAGER_ROLE})){%>
