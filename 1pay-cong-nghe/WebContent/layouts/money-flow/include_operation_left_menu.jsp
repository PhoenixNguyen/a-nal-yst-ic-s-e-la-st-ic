		...
		<li><a href="#" class="qtr_svr">Quản trị & vận hành</a>
			<ul>
				<%if(account.checkRoles(new String[]{Account.ACCOUNT_ADMIN_ROLE, Account.ACCOUNT_OPERATION_MANAGER_ROLE, Account.ACCOUNT_SHARE_HOLDER_ROLE, Account.ACCOUNT_CUSTOMER_CARE_ROLE})){%>
					<li><a href="<%= request.getContextPath()%>/protected/accounts.html" class="${merchantNavMenu?'slc_link':''}" >Quản lý Merchant</a></li>
				...
				<li><a href="<%=request.getContextPath()%>/money-flow/management.mf" class="${cashFlowManagement?'slc_link':''}">Quản lý dòng tiền</a></li>
			</ul>
		</li>
		<%} %>
	</ul>
