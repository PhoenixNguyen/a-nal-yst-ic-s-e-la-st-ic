						...
						<div class="right_content">
							...
							<div>
								<form id="cardSandBox" action="card-sand-box.html" method="post">
									<div id="dash_tab">
											<a id="cont" href="<%=request.getContextPath() %>/protected/card-sand-box.html" class="tab_slc"><span>Card Charging</span></a> 
									...
									<div id="filter_locketqua">
										...
										<div>
							                ...
							                <div class="filter_row">
							                 	<span class="add-on">Pin thẻ:</span>
							               		<form:input path="pin"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
							                 	<span class="add-on">Loại thẻ:</span>
