			...
			<div class="layout_1000">
				...
				<div id="w_body">
					<div class="row_sub">
						...
						<%if(account.checkRole(Account.ACCOUNT_STAFF_ROLE) && account.checkRoles(new String[]{Account.ACCOUNT_OPERATION_MANAGER_ROLE, Account.ACCOUNT_MERCHANT_MANAGER_ROLE, Account.ACCOUNT_BIZ_SUPPORTER_ROLE})){ %>
						...
						<div class="right_content">
							...
							<div>
								<div id="dash_tab">
									<a class="tab" href="<%=request.getContextPath() %>/protected/detail_comparison.html?id=${model.comparison_id}"><span>Chi tiết đối soát</span></a>
								...
								<div class="srv_row">
									...
									>
								    	...
								    	<display:column title="Thao tác" headerClass="transhead" class="transdata" style="border: 1px solid #CCC;" >
								    		<c:out value="${onepay:describeCamparisonAction(list.status_before, list.status_after)}"></c:out>
								    	</display:column>
