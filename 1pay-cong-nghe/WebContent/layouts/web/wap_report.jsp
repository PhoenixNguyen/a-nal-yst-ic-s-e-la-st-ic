				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div>
								<form id="smsReport" action="wap-report.html" method="get">
									<div id="dash_tab">
											...
											<a id="price" href="<%=request.getContextPath() %>/protected/wap-report.html" class="tab_slc"><span>WAP Charging</span></a>
											...
											<div class="filter_row">
												<div class="other_filter">
													...
													<select name="status" class="dashboard_filter">
														...
														<option value="0" ${param.a == '0'?'selected="selected"':''}>Không thành công</option>
													</select>
												</div>
               				...
               				<div class="srv_row">
								<display:table name="model.list" id="list" 
								    ...
								    <display:column title="Nhà mạng" headerClass="transhead" class="transdata" property="telco" style="border: 1px solid #CCC;" />
								     -->
								    <display:column title="Nội dung" headerClass="transhead" class="transdata" style="border: 1px solid #CCC;" >
								    ...
								    <display:column title="Thời gian" headerClass="transhead" class="transdata" property="timestamp" format="{0,date,yyyy-MM-dd HH:mm:ss}" style="border: 1px solid #CCC;" />
								    ...
								    <display:column title="Trạng thái" headerClass="transhead" class="transdata" sortProperty="status" style="border: 1px solid #CCC;text-align:center;">
										<c:choose>
											<c:when test="${list.status == '1' }">
												<img border="0" src="<%=request.getContextPath()%>/images/tick.png" title="Giao dịch thành công" />
											</c:when>
											<c:otherwise>
												<img border="0" src="<%=request.getContextPath()%>/images/error.png" title="${ not empty list.message ? list.message:'Không thành công'} " />
											</c:otherwise>
										</c:choose>
								    </display:column>
								</display:table>
