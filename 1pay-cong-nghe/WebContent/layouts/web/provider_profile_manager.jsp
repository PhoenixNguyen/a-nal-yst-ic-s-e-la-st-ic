								...
								<div>
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
														requestURI="provider_profile_manager.html" 
											...
											<display:column title="Charging" headerClass="transhead width110" class="transdata width90" style="border: 1px solid #CCC;">
										    	...
										    	<c:forEach items="${list.chargingRates}" var="chargingRate">
										    		...
										    		<c:if test="${chargingRate.key=='BANK'}">
											...
											<display:column title="Actions" headerClass="transhead width40" class="svr_data1" style="border: 1px solid #CCC;">
												<a href="<%=request.getContextPath() %>/protected/provider_profile_detail.html?code=${list.providerCode}" class="act_detail" title="Xem Merchant Profile" target="blank"></a>
										    </display:column>
