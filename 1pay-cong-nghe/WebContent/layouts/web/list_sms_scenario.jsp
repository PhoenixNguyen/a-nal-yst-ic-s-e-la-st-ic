				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							<h1 class="srv_title">SMS - Danh sách kịch bản</h1>
							<div class="dash_row">
			                	<div id="dash_tab">
			                    	<a href="#" class="tab_slc"><span>Tất cả</span></a>
			                        <a href="#" class="tab"><span></span></a>
			                        <a href="#" class="tab"><span></span></a>
			                        <a href="<%=request.getContextPath()%>/protected/create-sms-scenario.html" class="addproduct_link"><span>Thêm kịch bản</span></a>
			                        <div class="clear"></div>
			                    </div>
			                </div>
										...
										<div class="box_locketqua">
											...
											<div class="other_filter">
												...
												<select name="status"
													...
													<option value="-1" ${(param.status == null || param.status == '')?'selected="selected"':''}>Tất cả</option>
													<option value="1" ${param.status == '1'?'selected="selected"':''}>Bật</option>
													<option value="0" ${param.status == '0'?'selected="selected"':''}>Tắt</option>
												</select>
											</div>
											<div class="filter_row">
							                 	<span class="add-on">Tiêu đề:</span>
							               		<input type="text" name="title" value="${param.title}" class="txt_filter" />
							                </div>
							                <div class="filter_row">
							                 	<span class="add-on">MT mặc định:</span>
							                ...
							                <div class="filter_row">
							                 	<span class="add-on">Merchant:</span>
							               		<select name="merchant"
													class="dashboard_filter">
													<option value="" ${(param.merchant == null || param.merchant == '')?'selected="selected"':''}>Tất cả</option>
							...
							<div class="srv_row">
								...
								<display:table name="model.list" id="list" 
								    ...
								    <display:column title="MT mặc định" headerClass="transhead" class="transdata" property="defaultResp" style="border: 1px solid #CCC;" />
								    <display:column title="Ngày tạo" headerClass="transhead" class="transdata" property="createdTime" format="{0,date,yyyy-MM-dd HH:mm:ss}" style="border: 1px solid #CCC;" />
								    ...
								    <display:column title="Actions" headerClass="transhead width105" class="svr_data1" style="border: 1px solid #CCC;">
										    	<a href="edit-sms-scenario.html?id=${list.id }"
														class="act_edit" title="Sửa"></a>
												<a href="#" class="link_cancel" title="xóa" id="hd_delete_id-${list.id}" onclick="deleteKichBan('${list.id}');"></a>		
									</display:column>					
								</display:table>
							</div>
						</div>
