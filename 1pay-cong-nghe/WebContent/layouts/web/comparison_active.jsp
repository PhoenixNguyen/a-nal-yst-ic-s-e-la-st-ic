							...
							<h1 class="srv_title">Đối soát</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/import_comparison.html" class="addcomparison_link" style="margin-right: 5px;"><span>Tạo mới</span></a>
										<%} %>
										<div class="clear"></div>
									</div>
									...
									<div class="srv_row">
										<span>Có tất cả <strong><fmt:formatNumber value="${model.total}" currencyCode="vnd" /></strong> đối soát</span>
				                 		...
				                 		<span style="margin-left: 20px;">Tổng số tiền Merchant hưởng: <strong><fmt:formatNumber value="${model.finalTotalMcReceived}" maxFractionDigits="0" minFractionDigits="0" currencyCode="vnd" />đ</strong></span>
				                 	</div>
				                 	</c:if>
				                 	<div class="srv_row">
