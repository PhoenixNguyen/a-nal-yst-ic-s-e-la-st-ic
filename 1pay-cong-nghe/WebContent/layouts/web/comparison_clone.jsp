...
$(document).ready(function() {
	$('#form_action_save').live('click', function() {
		...
		$('#fee_open').val($('#fee_open').val().toString().replace(/\$|\,/g,''));
		$('#fee_maintain').val($('#fee_maintain').val().toString().replace(/\$|\,/g,''));
		$('#income_tax').val($('#income_tax').val().toString().replace(/\$|\,/g,''));
		$('#fee_chargeback').val($('#fee_chargeback').val().toString().replace(/\$|\,/g,''));
...
function clickFirstButton(){
	...
	var duochuong = $("#card_revenue").val();
	if(duochuong<0){
...
var table_content = function(){
	...
	if(true)
	{
		...
		//San luong
		html_ret += '<td class="svr_data" style="padding: 8px" align="center">';
			html_ret +=	'<span  id="td-sanluong-'+ zIndex +'">' + card_amount + '</span>';
			html_ret +=	'<input type="hidden" value="'+commifyCurrency(card_amount)+'" name="hd_sanluong_card" id="hd_sanluong_card-'+ zIndex +'">';
		html_ret +=	'</td>';
		//Ty le
		html_ret += '<td class="svr_data" style="padding: 8px" align="center">';
...
var table_content_sms = function(){
	...
	if(true)
	{
		...
		*/
		...
		//Duoc huong
		html_ret += '<td class="svr_data" style="padding: 8px" align="center">';
			html_ret +=	'<span  id="td-duochuong-'+ zIndex +'">' + sms_revenue + '</span>';
			...
			<div class="layout_1000">
				...
				<div id="w_body">
					<div class="row_sub">
						...
						<!-- Right Content -->
						<form:form id="create_comparison" name="create_comparison" commandName="clone_comparison" method="post">
						<div class="right_content">
							<h1 class="srv_title">Copy đối soát</h1>
							<div class="srv_row">
                			...
                			<div class="srv_row">
       	    					<table cellpadding="5" cellspacing="0">
									...
									<tr>
										...
										<td>
	                                        <b>${comparisonInfo.merchant}</b>
                                        </td>
									</tr>
									<tr>
										<td class="profile_label" width="200">Tên đối tác</td>
										<td>
	                                        <b>${comparisonInfo.merchant_name}</b>
	                                        <form:input path="merchantName" class="txt_reglog" style="display:none"/>
                                        </td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<b>${comparisonInfo.c_month}</b>
	                                        <form:select path="monthComparison" items="${months}" class="slc_gl" style="display:none"/>
	                                        /
	                                        <b>${comparisonInfo.c_year}</b>
	                                        <form:select path="yearComparison" items="${years}" class="slc_gl" style="display:none"/>
	                                        <!-- Lập đối soát tháng -->
	                                        <form:select path="month" items="${months}" class="slc_gl" style="display:none"/>
	                                        <form:select path="year" items="${years}" class="slc_gl" style="display:none"/>
	                                    </td>
									</tr>
									<tr>
										<td class="profile_label">
              			...
              			<div id="dash_tab">
              				<a href="#" id="tab_common_all" class="tab_common tab" title="all_charging_id"><span>Tất cả</span></a>
                    	...
                    	<div class="srv_row content" style="display: none;" id="all_charging_id">
	                        <div class="srv_row" style="width: 700px; margin:auto;"">
                				<table width="400px;" cellspacing="0" cellpadding="0" border="1" style="border-color: #CCC">
                       		...
                       		<tbody id="all_elecment_card">
                       			<c:if test="${not empty list_telco_card}">
		                        	<tr id="title_table_dk">
	                       				...
	                       				<td class="transhead" >Nhà mạng</td>
	                       				<td class="transhead" width="100" >Doanh thu</td>
	                       				<td class="transhead" width="100" >Tỷ lệ</td>
	                       				<td class="transhead" width="100" >Được hưởng</td>
	                       				<!-- 
	                       				<td  class="transhead" width="80" align="center">Chức năng</td>
	                       				 -->
	                       			</tr>
		                        </c:if>
               			...
               			<div class="srv_row">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form:input path="fee_open" class="txt_reglog" value="${fee_open}" maxlength="12" onkeyup="FormatNumber(this);"/>
									</td>
								</tr>
                                <tr>
									<td class="profile_label" width="140">
									...
									<td>
										<form:input path="fee_maintain" class="txt_reglog" value="${fFee_maintain}" maxlength="12" onkeyup="FormatNumber(this);"/>
                                    </td>
								</tr>
								
								<form:hidden path="income_tax" class="txt_reglog" value="${income_tax}" maxlength="12" onkeyup="FormatNumber(this);"/>
								<!-- 
                                <tr>
									<td class="profile_label" width="140">
										Thuế TNCN (nếu có)</td>
									<td>
										<form:input path="income_tax" class="txt_reglog" value="${income_tax}" maxlength="12" onkeyup="FormatNumber(this);"/>
                                    </td>
								</tr>
								 -->
                                 <tr>
									...
									<td>
										<form:input path="fee_chargeback" class="txt_reglog" value="${fee_chargeback}" maxlength="12" onkeyup="FormatNumber(this);"/>
                                    </td>
								</tr>
                                <tr>
									<td class="profile_label" width="140">
