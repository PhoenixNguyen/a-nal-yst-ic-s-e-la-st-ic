...
<div id="wrapper"> 
    ...
    <div class="layout_1000"> 
          ...
          <div id="w_body">
      		...
      		<jsp:include page="include_wap_contract_info_header.jsp"></jsp:include>
      		
        <div class="hdr_02">
              <table id="steps">
            <tbody>
                  <tr>
                  <td><a class="link_xemhd_focus" title="Review contract & provide you information"></a>
            ...
            <div class="hdr_03">
            	<div class="form_row">Please review this sample contract before fullfill your information</div>
                ...
                <div class="form_row">	
                     <input value="Next step" class="btn_nextstep" type="button" onclick="location.href='<%=request.getContextPath() %>/protected/wap_contract_step_02.html'"/>
                 </div>
            </div>
      </div>
