					...
					<div class="srv_row" align="center">
						<c:choose>
							<c:when test="${model.err == 0}">
								Kích hoạt tài khoản thành công, vui lòng <a href="<%= request.getContextPath()%>/protected/profile.html" style="color:#00f;text-decoration: underline;">Đăng nhập</a> để sử dụng dịch vụ
								<c:if test="${account_logined.phone==null }">
									...
									<script>
										var url = "<%=request.getContextPath()%>/protected/verify_phone.html";
										var delay = 3000;
										setTimeout(function() {
