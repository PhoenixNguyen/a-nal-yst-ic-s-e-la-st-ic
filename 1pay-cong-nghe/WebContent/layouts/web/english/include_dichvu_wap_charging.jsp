			...
			<div class="srv_details_box">
				...
				<div class="srv_details">
					...
					<div class="srv_mainfeature">
						<a href="<%= request.getContextPath() %>/wap/chinh-sach.html" class="srv_feature_link"><img
							src="images/document_icon.png" border="0" hspace="5"
							align="absmiddle" />policy</a> · 
							<c:choose>
								<c:when test="${account_activated_chargings!=null && account_activated_chargings[wap_charging_code]}">
									<a href="<%=request.getContextPath() %>/protected/wap_contract.html" class="srv_feature_link">
								</c:when>
								<c:otherwise>
							...
							border="0" hspace="5" align="absmiddle" />Electric contract</a> · <a
