										...
										<div class="box_locketqua">
											...
											<div class="filter_row">
								                ...
								                <div style="display: block;float: right;">
								                 	...
								                 	<select id="status" name="status" class="dashboard_filter">
								                 		...
								                 		<option value="-1" ${(param.status == '-1')?'selected="selected"':''}>Khởi tạo đối soát</option>
								                 		<option value="0" ${(param.status == '0')?'selected="selected"':''}>Đề nghị duyệt sơ bộ</option>
								                 		<!-- 
							                ...
							                <div class="filter_row">
							                	...
							                	<fieldset class="fieldset_filter">
													...
													<input type="checkbox" ${fn:contains(allCharging, 'IAC')?'checked="checked"':'' } title="IAC" value="IAC" name="chargingService_" class="chck_filter chargingService" id="chargingService_"> 
