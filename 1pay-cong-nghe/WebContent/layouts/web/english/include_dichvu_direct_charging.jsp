...
<div id="w_body">
	<div class="row_sub">
		<%request.setAttribute("directCharging", true);%>
		<jsp:include page="include_dichvu_menu.jsp"></jsp:include>
		
		<div class="right_content">
			<div class="srv_details_box">
				<div class="srv_img_thumb">
					<img src="images/direct_charging-logo.jpg" border="0" /> <a href="#"
						class="btn_dangkysrv">Kích hoạt dịch vụ</a>
				</div>
				<div class="srv_details">
					<h1 class="srv_title">Direct Charging</h1>
		
					<div class="srv_detail_des">Dịch vụ cho thuê đầu số và hạ tầng
						kết nối nhắn tin cho các cá nhân, doanh nghiệp có nhu cầu sử dụng
						tổng đài tin nhắn làm phương tiện thu phí cho các dịch vụ tiện ích,
						hay kinh doanh nội dung số.</div>
