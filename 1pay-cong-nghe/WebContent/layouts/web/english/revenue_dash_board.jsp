																	...
																	<td class="svr_data">
																		<table cellpadding="0" cellspacing="0" width="100%" border="0">
																			<tr>
																				...
																				<td>
																					<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'chargingService',item.chargingService) }"><strong><c:out value="${item.chargingService }" /></strong></a>
																				</td>
																			</tr>
																		</table>
																	</td>
