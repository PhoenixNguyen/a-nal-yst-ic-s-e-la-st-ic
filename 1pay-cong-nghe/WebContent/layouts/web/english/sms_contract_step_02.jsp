    ...
    <div class="layout_1000"> 
        ...
        <div class="hdr_02">
            ...
            <tbody>
                ...
                <td><a class="link_xacnhanhd_focus" title="Review contract & provide your information"></a>
                    ...
                    <div class="form_row">
                        ...
                        <div class="form_row">
							...
							<c:if test="${merchantContract.status==4 && merchantContract.identity!=null && merchantContract.identity!=''}">
								...
								<input type="hidden" id="Identification" value="${merchantContract.identity}"/>
							</c:if>
                        </div>
                         <div class="form_row">
                        ...
                        <div class="form_row">
                        	<c:if test="${merchantContract.status!=4 || merchantContract.phone==null || merchantContract.phone==''}">
								<form:input path="phone" cssClass="txt_hd" title="Phone numbe" placeholder="Phone numbe" onfocus="clear(this)" />
							</c:if>
							<c:if test="${merchantContract.status==4 && merchantContract.phone!=null && merchantContract.phone!=''}">
								<span style="display: inline-block; width: 100px;">Phone number</span>: ${merchantContract.phone}
