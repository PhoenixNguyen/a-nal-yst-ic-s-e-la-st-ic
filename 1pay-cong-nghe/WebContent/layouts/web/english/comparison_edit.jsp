...
var table_content_iac = function(){
	...
	if(true)
	{
		...
		if(iac_revenue==0)
		{
			iac_revenue=iac_amount*iac_rate/100;
		}
		...
		html_ret += '<td class="svr_data" style="padding: 8px" align="center">';
			...
			html_ret +=	'<input type="hidden" value="'+iac_rate+'" name="hd_tyle_iac" id="hd_tyle_iac-'+ zIndex +'">';
		html_ret +=	'</td>';
		//Duoc huong
		html_ret += '<td class="svr_data" style="padding: 8px" align="center">';
			...
			<div class="layout_1000">
				...
				<div id="w_body">
					<div class="row_sub">
						...
						<!-- Right Content -->
						<form:form id="create_comparison" name="create_comparison" commandName="edit_comparison" method="post">
						<div class="right_content">
              			...
              			<div id="dash_tab">
	                        ...
	                        <c:if test="${not empty ls_iac_telco}">
	                        	<a href="#" id="tab_common_iac" class="tab_common tab" title="iac_charging_id"><span>Iac Charging</span></a>
	                        </c:if>
	                        <div class="clear"></div>
                    	</div>
                				...
                				<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-color: #CCC">
			                       			<tbody id="all_elecment_card">
			                       				<tr id="title_table_dk">
				                       				...
				                       				<td class="transhead" width="160" >Doanh thu(đ)</td>
				                       				<td class="transhead" width="160" >Được hưởng(đ)</td>
				                       			</tr>
				                       			<tr>
												...
												<tr>
													...
													<td class="svr_data" style="padding: 8px;text-align: right;" width="160" align="center">
														<c:if test="${not empty total_amount_group_wap}">
															...
															<span id="tb_amount_wap"><c:out value="${total_amount_group_wap_}"></c:out></span>
														</c:if>
                       		...
                       		<tbody id="all_elecment_card">
                       			<c:if test="${not empty list_telco_card}">
		                        	<tr id="title_table_dk">
	                       				...
	                       				<td class="transhead" width="100" >Doanh thu(đ)</td>
	                       				<td class="transhead" width="100" >Tỷ lệ</td>
	                       				<td class="transhead" width="100" >Được hưởng(đ)</td>
	                       				<!-- 
