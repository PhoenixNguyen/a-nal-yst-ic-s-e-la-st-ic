											...
											<div class="filter_row">
								                ...
								                <div style="display: block;float: right;">
								                 	...
								                 	<select id="status" name="status" class="dashboard_filter">
								                 		...
								                 		<option value="9" ${(param.status == '11')?'selected="selected"':''}>11-Merchant cancel payment confirmation</option>
								                 	</select>
								                </div>
								                </c:if>
							                </div>
							                <div class="filter_row">
							                	<span class="add-on" style="padding-left:40px; display:block; width:100px;">Report period:</span>
