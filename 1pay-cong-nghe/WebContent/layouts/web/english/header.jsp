...
<div id="w_header">
	...
	<div id="nav">
		<ul id="qm0" class="qmmc">
			<li><a class="qmparent nav_menu${menuTrangChu?'_slc':''}" href="<%=request.getContextPath()%>/trang-chu.html">Home</a></li>

			<li><a class="qmparent nav_menu${menuDichVu?'_slc':''}" href="<%=request.getContextPath()%>/dich-vu.html">Services</a>
				<ul>
			...
			<li><a class="qmparent nav_menu${menuNhaPhatTrien?'_slc':''}" href="http://dev.1pay.vn">Developers</a>
				<%-- <ul>
					<li><a href="<%=request.getContextPath()%>/nha-phat-trien.html">Công cụ</a></li>
					<li><a href="http://dev.1pay.vn">Tài liệu APIs</a></li>
					<li><a href="<%=request.getContextPath()%>/nha-phat-trien/huong-dan.html">Support</a></li>
					<li><a href="<%=request.getContextPath()%>/merchant-support.html">Utility support </a></li>
				</ul> --%>
			</li>


			<li><a class="qmparent nav_menu${menuCongDong?'_slc':''}" href="http://forum.1pay.vn">Community</a>
				<ul>
					<li><a href="http://forum.1pay.vn">Forum </a></li>
			...
			<li><a href="<%= request.getContextPath() %>/news/category.html" class="qmparent nav_menu${menuTinTuc?'_slc':''}">News</a>
				<ul>
					<li><a href="<%= request.getContextPath() %>/news/category.html">News</a></li>
					<li><a href="<%= request.getContextPath() %>/news/category.html">Events</a></li>
					<li><a href="<%= request.getContextPath() %>/news/category.html">ICT News</a></li>
				</ul>
			</li>

			<li><a class="qmparent nav_menu${menuHoTro?'_slc':''}" href="<%=request.getContextPath() %>/lien-he.html">Support</a>
				<ul>
					<li><a href="http://help.1pay.vn">Help center</a></li>
					<li><a href="<%=request.getContextPath() %>/dieu-khoan.html">Terms of Use</a></li>
					<li><a href="<%=request.getContextPath() %>/chinh-sach-thanh-toan.html">Payment Policy</a></li>
					<li><a href="<%=request.getContextPath() %>/ban-quyen.html">Copyright</a></li>
					<li><a href="<%=request.getContextPath() %>/lien-he.html">Contact us</a></li>
				</ul>
			</li>
			<li class="qmclear">&nbsp;</li>
		</ul>
	...
	<div id="account-header">
		<ul class="nav">
				...
				<li class="ui-button">
					...
					<div class="sub-nav chat-bubble" align="left">
						<ul>
							...
							<%
							if(!SharedConstants.MBIZ && account.checkRoles(new String[]{Account.ACCOUNT_ADMIN_ROLE, Account.ACCOUNT_OPERATION_MANAGER_ROLE})){
							%>
							<li><a href="<%= request.getContextPath()%>/protected/cash-flow.html">Cashflow</a></li>
							<%} %>
							<%
							...
							%>
							<li><a href="<%= request.getContextPath()%>/protected/email-announcement.html">Email Alert</a></li>
							<%} %>
							<%
								if(account.checkRoles(new String[]{Account.ACCOUNT_ADMIN_ROLE, Account.ACCOUNT_OPERATION_MANAGER_ROLE})){
							%>
							...
							<%} %>
							<li><a href="<%= request.getContextPath()%>/protected/profile.html">Configuration</a></li>
			...
			<li>
				...
				<a href="<%= request.getContextPath()%>/protected/index.html"><img src="<%=request.getContextPath()%>/images/door-open-in.png"
