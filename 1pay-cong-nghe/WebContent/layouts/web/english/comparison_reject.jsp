							...
							<h1 class="srv_title">Revenue Report</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/comparison_active.html" class="tab"><span>Revenue Report</span></a>
										<a href="#" class="tab_slc"><span> Report has been cancelled</span></a>
										...
										<a href="<%=request.getContextPath() %>/protected/import_comparison.html" class="addcomparison_link"><span>Create new</span></a>
										<%} %>
										<div class="clear"></div>
									</div>
									<form id="list-sms-scenario" action="comparison_reject.html" method="post">
										<jsp:include page="include_box_filter_comparison_reject_all.jsp"></jsp:include>
									</form>
									...
									<div class="srv_row">
										<fmt:formatNumber var="totalItems" value="${model.total}" currencyCode="vnd" />
				                 		<strong><c:out value="${totalItems}" />search results for report</strong> 
				                 	</div>
				                 	</c:if>
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
														requestURI="comparison_reject.html" 
										    ...
										    <display:column title="Charging" headerClass="transhead" class="transdata" style="border: 1px solid #CCC;">
											...
											<display:column title="Status" headerClass="transhead width160" class="svr_data1" style="border: 1px solid #CCC;">
										    	<div style="display:none">
										    		<!-- Duyet so bo -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink require_preliminary_approval card_invi" title="Cancel" href="#require_preliminary_approval" name="require_preliminary_approval"  rel="leanModal123"></a>
										    		<!-- Duyet so bo -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink preliminary_approval card_invi" title="Cancel" href="#preliminary_approval" name="preliminary_approval"  rel="leanModal123"></a>
										    		
										    		<a id="${list.id}" class="sms_avai1 act_copylink comparison_info_pop card_invi" title="Cancel" href="#smschar_pop" name="smschar_pop"  rel="leanModal123"></a>
										    		
										    		<!-- Merchant xác nhận -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink merchant_approval card_invi" title="Cancel" href="#merchant_approval" name="merchant_approval"  rel="leanModal123"></a>
										    		<!-- /Merchant xác nhận -->
										    		<!-- Duyet chinh thuc -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink offical_approval card_invi" title="Cancel" href="#offical_approval" name="offical_approval"  rel="leanModal123"></a>
										    		<!-- /Duyet chinh thuc -->
										    		<!-- Thanh toán -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink billing_approval card_invi" title="Cancel" href="#billing_approval" name="billing_approval"  rel="leanModal123"></a>
										    		<!-- /Thanh toán -->
										    		<!-- Merchant xác nhận thanh toán-->
										    		<a id="${list.id}" class="sms_avai1 act_copylink merchant_approval_bill card_invi" title="Cancel" href="#merchant_approval_bill" name="merchant_approval_bill"  rel="leanModal123"></a>
										    		<!-- /Merchant xác nhận thanh toán-->
										    		<!-- Thông tin đối soát -->
										    		<a id="${list.id}" class="sms_avai1 act_copylink info_comparison_common card_invi" title="Cancel" href="#info_comparison_common" name="info_comparison_common"  rel="leanModal123"></a>
										    		<!-- /Thông tin đối soát -->
										    	</div>
										    	
										    	<a class="comparison_active yeucauduyetsobo" id="${list.id}" pname="${list.title}" title="Report is supported"></a>
											...
											<display:column title="Actions" headerClass="transhead width100" class="svr_data1" style="border: 1px solid #CCC;">
										    	<a href="detail_comparison.html?id=${list.id}" class="act_detail" title="Report detail" target="blank"></a>
										    	<c:if test="${list.status == -1 || list.status == 0 || list.status == 2 || list.status== 4 || list.status==6 || list.status==8}">
										    		<a href="edit_comparison.html?id=${list.id}" class="link_denghi" title="Edit Report"></a>
										    	</c:if>
