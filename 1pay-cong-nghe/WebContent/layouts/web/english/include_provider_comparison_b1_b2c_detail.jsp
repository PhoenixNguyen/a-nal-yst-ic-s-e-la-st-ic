...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td width="50%"><strong>II - Các chi phí [${model.comparison.provider}] bị giảm trừ là (II.1+II.2+II.3+II.4+II.5): </strong></td>
  ...
  <tr>
    <td width="50%" style="padding-left: 30px;"><strong>II.1 - Phí mở mã (80.000 đ/ mã):</strong></td>
  ...
  <tr>
    <td width="50%" style="padding-left: 30px;"><strong>II.2 - Phí duy trì mã (32.000 đ/ mã):</strong></td>
  ...
  <tr>
    ...
    <fmt:formatNumber value="${model.comparison.income_tax}" var="income_tax" currencyCode="vnd" minFractionDigits="0" maxFractionDigits="0" />
  ...
  <tr>
    <td width="50%"><strong>III -  Tổng doanh thu <span style="color: red"> [${model.comparison.provider}]  </span> được hưởng còn lại (I-II):</strong></td>
  ...
  <tr>
    <td width="50%"><strong>IV -  Tổng số tiền 1PAY đã tạm ứng  <span style="color: red"> [${model.comparison.provider}]  </span>  là:</strong></td>
  ...
  <tr>
    <td width="50%"><strong>V - Tổng số tiền 1PAY phải trả cho <span style="color: red">[${model.comparison.provider}] </span>   là (III-IV):</strong></td>
