									...
									<!-- .widget-header -->
										<div class="box_locketqua">
											<div class="filter_row">
												<span style="padding-left:40px; display:inline-block; width:100px;">Search merchant: </span>
											...
											<div class="filter_row">
								                ...
								                <div style="display: block; float: right;">
								                 	...
								                 	<select id="status" name="status" class="dashboard_filter">
								                 		...
								                 		<option value="3" ${(param.status == '3')?'selected="selected"':''}>3-Preliminary summit cencelled</option>
								                 		<option value="4" ${(param.status == '4')?'selected="selected"':''}>4-Merchant confirmation awaiting</option>
								                 		<option value="5" ${(param.status == '5')?'selected="selected"':''}>5-Merchant cancelled the confirmation</option>
								                 		<option value="6" ${(param.status == '6')?'selected="selected"':''}>6-Official/Final approval awaiting</option>
								                 		<option value="7" ${(param.status == '7')?'selected="selected"':''}>7-Final approval Cancelled</option>
								                 		<option value="8" ${(param.status == '8')?'selected="selected"':''}>8-Payment awaiting</option>
								                 		<option value="9" ${(param.status == '9')?'selected="selected"':''}>9-Payment cancelled</option>
								                 		<option value="10" ${(param.status == '10')?'selected="selected"':''}>10-Payment is done</option>
								                 		<option value="11" ${(param.status == '11')?'selected="selected"':''}>11-Merchant cancel payment confirmation</option>
								                 		<option value="12" ${(param.status == '12')?'selected="selected"':''}>12-Merchant confirmed payment has been</option>
								                 	</select>
								                </div>
								                </c:if>
							                </div>
							                ...
							                <div class="filter_row">
												...
												<fieldset class="fieldset_filter">
                                                    ...
                                                    <label for="chck_thecao" class="lbl_chcksub">CARD</label>
