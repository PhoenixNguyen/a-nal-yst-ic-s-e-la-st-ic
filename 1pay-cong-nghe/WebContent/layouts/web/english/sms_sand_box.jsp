						...
						<div class="right_content">
							...
							<div>
								<form id="smsSandBox" action="sms-sand-box.html" method="post">
									<div id="dash_tab">
											<a id="cont" href="<%=request.getContextPath() %>/protected/card-sand-box.html" class="tab"><span>Card Charing</span></a> 
											<a id="telco" href="<%=request.getContextPath() %>/protected/sms-sand-box.html" class="tab_slc"><span>SMS Charing</span></a> 
										...
										<c:if test="${ smsSandBox.signature!=null && smsSandBox.signature!=''}">
											...
											<div class="filter_row">
												...
												<c:choose>
													...
													<c:otherwise>
														<img border="0" src="<%=request.getContextPath()%>/images/error.png" title="Received content isn't true!" />
													</c:otherwise>
												</c:choose>
												<br/>
												<strong>Example is true:</strong><br/>
												{"status":1, "sms":"Hello", "type":"text"}
							                </div>
							             	</div>
										</c:if>
										</form:form>
