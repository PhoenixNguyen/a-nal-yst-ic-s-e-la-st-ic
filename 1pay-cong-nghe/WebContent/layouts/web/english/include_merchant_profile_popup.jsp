	...
	<form action="<%=request.getContextPath()%>/protected/merchant-profile-ajax.html" method="post" name="manager_profile_merchant_confirm_verify">
		...
		<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />
                    <div class="pop_box">
                        ...
                        <h1 class="srv_title">Merchant's contract has not been done</h1>
                        </div>
                        ...
                        <div class="srv_row srv_row_margin">
                        	<div class="w_50">
                                ...
                                <div class="contract_content"> 
                                    ...
                                    <img class="status_verify_email" border="0" width="16" height="16" src="<%=request.getContextPath()%>/images/invalid.png" title="Unverified"/>
                                ...
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Phone number: </label>
                                    <span class="go_sms_product_name popup_merchant_phone"></span>
                                    <img class="status_verify_phone" border="0" width="16" height="16" src="<%=request.getContextPath()%>/images/invalid.png"  title="Unverified"/>
                                	<span class="button_veriry_phone">
                                		[<a href="<%=request.getContextPath()%>/protected/verify_phone.html" target="_blank" class="link_feature" title="Xac thuc so dien thoai" style="color: #0066cc">Verified</a>]
                                	</span>
                                </div>
                                ...
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Expiration date: </label>
                                    <span class="popup_contract_expired_date_"></span>
                                </div>
                                
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Hard copy contract:</label>
                                    <span class="popup_hasHardCopy"></span>
                                    <span class="popup_hardcopy"></span>
                                </div>
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Payment appendix:</label>
                                    <div style="display: inline-block;width:250px;">
	                                    ...
	                                    <span class="popup_hasHardIacCopy" style="display: inline-block;"></span>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Effect time</label>
                                    <span class="popup_effective_date_fmt"></span>
                                </div>
                                
                                <div class="contract_content">
		                        	<label class="label_popup_edit_contact">Status:</label>
								...
								<div class="contract_content">
			                        <label class="label_popup_edit_contact"> Rate information:</label>
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
							...
							<input name="reset" value="Ignore" class="btn_graysmall modal_close" type="reset" />
                        </div>
                    </div>
                </form>
</div>
...
<div style="display: none; position: fixed; opacity: 1; z-index: 11000; left: 50%; margin-left: -360px; top: 0px;" id="merchant_confirm_contract_rates"  class="style_formpopup_common popup_mc_info_contract">
	<form action="<%=request.getContextPath()%>/protected/merchant-profile-ajax.html" method="post" name="manager_profile_merchant_confirm">
		...
		<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />
                        ...
                        <div class="srv_row srv_row_margin">
                        	<div class="w_50">
                                ...
                                <div class="contract_content"> 
                                	...
                                	<span>
                                    <input type="checkbox" title="Automatic validation" value="autoExtendedContract" name="autoExtendedContract_common" class="chck_filter autoExtendedContract_common" id="autoExtendedContract_common"/>
                    ...
                    <div style="width:670px">
                    	<div class="product_title">
                        	<label class="label_popup_profile">Status:</label>
                        	<span class="go_sms_product_name popup_status_view" id="popup_status_view"></span>
                        	<label style="padding-left: 10px;">(Reference Profile: </label>
                    ...
                    <div class="pop_box">
                        ...
                        <div class="srv_row srv_row_margin">
                        	<div class="w_50">
                                ...
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact">Report period<span style="color: #FF0000; font-weight: normal">(*)</span>:</label>
                                ...
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact"> &nbsp; </label>
                                	<span>
                                    <input type="checkbox" title="Automatic validation" value="autoExtendedContract" name="autoExtendedContract_support" class="chck_filter chargingService" id="autoExtendedContract_support"/>
                                    Automatic validation
                                    </span>
                                </div> 
                                <!-- 
                                ...
                                <div class="product_slc_filter filter_row">
									<fieldset class="identity_verify_popup">
										<legend>
											<strong>
												CMND/ĐKKD &nbsp; 
												<img class="popup_common_identity_verify" border="0" title="Identification/ Business license unverified" src="<%=request.getContextPath()%>/images/invalid.png"/>
											</strong>
										</legend>
										<div style="padding: 2px;">
											<div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Identification/ Business license<span style="color: #FF0000; font-weight: normal">(*)</span>: </label>
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
	                        ...
	                        <label class="lbl_rempass" for="chck_rempass">
								...
								<input type="submit" name="reject" value="Deny" class="btn_merchant_profile_preview" />
								<input name="reset" value="Ignore" class="btn_graysmall modal_close" type="reset"/>
	                        </label>
                        </div>
										...
										if(validate_merchant_profile=='1')
										{
											...
											*/
											...
											if(popup_merchant_identity.length==0) {
						    					alert('Please Enter Identification/ Business license number');
						    					return false;
						    				}else{
                        ...
                        <div class="srv_row srv_row_margin">
                        	<div class="w_50">
                                ...
                                <div class="contract_content"> 
                                	<label class="label_popup_edit_contact"> &nbsp; </label>
                                	<span>
                                    <input type="checkbox" title="Automatic validation" value="autoExtendedContract" name="autoExtendedContract_approved" class="chck_filter chargingService" id="autoExtendedContract_approved"/>
                                    Automatic validation
                                    </span>
                                </div> 
                                <!-- 
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
	                        ...
	                        <label class="lbl_rempass" for="chck_rempass">
								...
								<input type="submit" name="approve" value="Phê duyệt" class="btn_greensmall" />
								<input type="submit" name="reject" value="c" class="btn_merchant_profile_preview" />
								<input name="reset" value="Ignore" class="btn_graysmall modal_close" type="reset">
	                        </label>
                        </div>
...
<!-- /(5)Duyệt profiles -->
	...
	<script type="text/javascript">
		...
		function resetContentPopup()
		{
			...
			$(".status_verify_email").attr("title",'Unverified');
			...
			$(".status_verify_phone").attr("title",'Unverified');
			...
			//Thông tin thanh toán
			$(".popup_billing_info_billing_type").html('<i style="color:red;">Unavailable</i>');
			$(".popup_billing_info_account_holder").html('<i style="color:red;">Unavailable</i>');
			$(".popup_billing_info_account_number").html('<i style="color:red;">Unavailable</i>');
			$(".popup_billing_info_bank_name").html('<i style="color:red;">Unavailable</i>');
			$(".popup_billing_info_city_bank").html('<i style="color:red;">Unavailable</i>');
			$(".popup_billing_info_branch_bank").html('<i style="color:red;">Unavailable</i>');
			...
			$(".popup_common_identity__identity").html('<i style="color:red;">Unavailable</i>');
			$(".popup_common_identity_place_of_issue").html('<i style="color:red;">Unavailable</i>');
			$(".popup_common_identity_date_of_issue").html('<i style="color:red;">Unavailable</i>');
											...
											$(document).ready(function() {
												...
												$('.duyetsobo').live('click', function() {
													...
													if(hasHardCopy=='true'){
														...
														$(".popup_hasHardCopy").html('<i style="color:red;">Unavailable</i>');
														$(".popup_hardcopy").html('');
													} */
													//bản cứng HĐ
													var path_contract_uri = $("#path_contract_uri").val();
													...
													var hd_linkHardCopy = $("#hd_linkHardCopy-"+pid, data).val();
													var href = '<i style="color:#f00;">Unavailable</i>';

													if(hd_linkHardCopy!=null && hd_linkHardCopy!=''){
														href='<a class="hard_link"  target="_blank" href="' + host + hd_linkHardCopy + '">Tải về</a>';
													}
													var hasHardCopy = $("#hd_hasHardCopy-"+pid, data).val();
													$(".popup_hasHardCopy").html('<input type="checkbox"' + (hasHardCopy == 'true' ? ' checked="checked"' : '') + ' disabled="true" /> ' + href);
													$(".popup_hardcopy").html('');
													...
													else $(".popup_profile_reference").html('<i style="color:red;">Unavailable</i>');
													...
													if(paymentInfo!=null && paymentInfo!=''){
														...
														$(".popup_paymentInfo").html('<i style="color:red;">Unavailable</i>');
													}
													...
													if(effectiveDateFmt!=null && effectiveDateFmt!='' && effectiveDateFmt.length!=0){
														...
														$(".popup_effective_date_fmt").html('<i style="color:red;">Unavailable</i>');
												...
												$('.merchantxacnhan').live('click', function() {
													...
													if(merchant_email!=null && merchant_email!='' && merchant_email.length!=0)$(".popup_merchant_email").html(merchant_email);
													else $(".popup_merchant_email").html('<i style="color:red;">Unavailable</i>');
												...
												$('.duyetchinhthuc').live('click', function() {
													...
													if(identity!=null && identity!='' && identity.length!=0){
														$(".popup_merchant_identity").html(identity);
														$(".popup_merchant_identity").html(identity);
													}else $(".popup_merchant_identity").html('<i style="color:red;">Unavailable</i>');
													...
													*/
													...
													if(contract_expired_date!=null && contract_expired_date!='' && contract_expired_date.length!=0){
														$(".popup_contract_expired_date_").html(contract_expired_date);
														$(".popup_contract_expired_date_").html(contract_expired_date);
													}else $(".popup_contract_expired_date_").html('<i style="color:red;">Unavailable</i>');
												...
												$('.thanhtoan').live('click', function() {
													...
													*/
													...
													if(hd_proposedDateFmt!=null && hd_proposedDateFmt!='' && hd_proposedDateFmt.length!=0){
														...
														$(".popup_proposed_effective_date").html('<i style="color:red;">Unavailable</i>');
													        	...
													        	if(dataresponse.strError !=null && dataresponse.strError !="undefined") {
														        	...
														        	if(dataresponse.result ==1)
														        	{
														        		...
														        		if(childReference!=null && childReference!='' && childReference.length!=0){
														        			note='Không được phép clone: Đang tồn tại 1 bản <a class="hard_link" target="_blank" href="<%=request.getContextPath()%>/protected/merchant_profile_detail.html?id='+childReference+'">profile clone đang xử lý</a>';
																		}
