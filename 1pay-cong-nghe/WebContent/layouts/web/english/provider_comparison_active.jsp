							...
							<h1 class="srv_title">Đối soát Provider</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="#" class="tab_slc"><span>Đối soát</span></a>
									...
									<form id="provider_comparison_active" action="provider_comparison_active.html" method="post">
										<jsp:include page="include_box_filter_provider_comparison_active.jsp"></jsp:include>
									</form>
