						...
						<div class="right_content">
							<h1 class="srv_title">Revenue Report</h1>
								<div>
									...
									<form id="list-sms-scenario" action="comparison.html" method="get">
									...
									<div class="srv_row">
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
										    ...
										    <!-- DT chia sẻ (đ) &nbsp;<img id='myTip' src='../images/question.png' title='Note' style='vertical-align: bottom; margin-right: 5px;' width='16px'/> -->
										    <display:column title="Amount<br />Merchant enjoy" headerClass="transhead" class="transdata" style="border: 1px solid #CCC;text-align:right; width:85px">
												...
												<script type="text/javascript">
													$(document).ready(function() {
														$('.link_denghidoisoat').live('click', function() {
															var alertMess = 'Do you want to propose preliminary submit?';
