				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div class="srv_row">
								<label class="lbl_moi">Step 2:</label> Enter OTP confirmation code.
							</div>
							<div>
							    Please check your SMS to get your OTP confirmation code
							</div>
							<div class="srv_row">
								<form name="activedOTP" action="<%=request.getContextPath() %>/protected/verify_phone_otp.html" method="post">
									<input type="hidden" name ="action" value="otp"/>
									<div class="form_row">
										<input type="text"name="otp" class="txt_reglog is_numeric" title="OTP confirmation code" placeholder="OTP confirmation code" onfocus="clear(this)" maxlength="6"/>
