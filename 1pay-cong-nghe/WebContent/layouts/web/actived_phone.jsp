				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div>
								<form name="activedPhone" action="<%=request.getContextPath() %>/protected/actived-phone.html" method="post">
									<input type="hidden" name ="action" value="phone"/>
									<div class="form_row">
										<c:choose>
											<c:when test="${model.phone!=null }">
												<input type="text"name="phone" class="txt_reglog" title="Số điện thoại" value="${model.phone }" placeholder="Số điện thoại" onfocus="clear(this)" />
											</c:when>
											<c:otherwise>
												<input type="text"name="phone" class="txt_reglog" title="Số điện thoại" placeholder="Số điện thoại" onfocus="clear(this)" />
											</c:otherwise>
										</c:choose>
