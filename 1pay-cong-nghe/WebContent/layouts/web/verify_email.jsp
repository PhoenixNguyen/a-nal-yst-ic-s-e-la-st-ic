				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							<h1 class="srv_title">Xác thực email</h1>
							
							<c:if test="${model.notification==null && model.verify_email==false}">
								<div class="srv_row">
									<label class="lbl_moi">Bước 1:</label> Nhập email của bạn.
								</div>
							</c:if>
							<div>
								<c:choose>
									...
									<c:when test="${model.verify_email==true}">
										...
										<div style="width:670px">
					                    	<div class="product_title">
					                        	...
					                        	<img src="/1pay/images/tick.png" alt="Email đã xác thực"/>
					                        </div>
					                    </div>
									</c:when>
									<c:otherwise>
											...
											<div class="form_row">
												<c:choose>
													<c:when test="${model.email!=null }">
														<input type="text"name="phone" class="txt_reglog is_email" title="Địa chỉ email" value="${model.email }" placeholder="Địa chỉ email" onfocus="clear(this)" maxlength="50"/>
													</c:when>
													<c:otherwise>
														<input type="text"name="phone" class="txt_reglog is_email" title="Địa chỉ email" placeholder="Địa chỉ email" onfocus="clear(this)" maxlength="50"/>
													</c:otherwise>
												</c:choose>
