				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div>
								<form id="iacSandBox" action="iac-sand-box.html" method="post">
									<div id="dash_tab">
											<a id="cont" href="<%=request.getContextPath() %>/protected/card-sand-box.html" class="tab"><span>Card Charging</span></a> 
											<a id="telco" href="<%=request.getContextPath() %>/protected/sms-sand-box.html" class="tab"><span>SMS Charging</span></a>
											<a id="telco" href="<%=request.getContextPath() %>/protected/iac-sand-box.html" class="tab_slc"><span>SMS Plus Charging</span></a>
											<!--  
									...
									<div id="filter_locketqua">
										<!-- .widget-header -->
										<form:form name="iacSandBox" commandName="iacSandBox" method="post">
										<div>
							                ...
							                <div class="filter_row">
							                 	<span class="add-on">Game Code:</span>
							               		<form:input path="command_code"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
							                 	<span class="add-on">Amount:</span>
							               		<form:input path="amount"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
							                 	<span class="add-on">Thông tin thêm:</span>
							               		<form:input path="info"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
										...
										<!-- .widget-content -->
										<c:if test="${ iacSandBox.signature!=null && iacSandBox.signature!=''}">
											<h3>Kết quả</h3>
											<div>
											 <div class="filter_row">
											...
											<div class="filter_row">
												...
												<c:choose>
													<c:when test="${iacSandBox.isSuccess }">
