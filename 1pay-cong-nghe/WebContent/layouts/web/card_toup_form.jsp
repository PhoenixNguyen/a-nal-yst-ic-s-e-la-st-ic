				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							<h1 class="srv_title">Tạo mã nhúng nạp thẻ.</h1>
							<div>
									<div id="dash_tab">
										...
										<div>
											<div class="filter_row">
												<c:if test="${ cardToupForm.ma_nhung!=null && cardToupForm.ma_nhung!=''}">
								                 	<span class="add-on">Sản phẩm:</span>
											 	...
											 	<c:if test="${ cardToupForm.ma_nhung==null || cardToupForm.ma_nhung==''}">
											 		Sản phẩm của bạn chưa được khai báo hoặc chưa kích hoạt
											 	</c:if>
