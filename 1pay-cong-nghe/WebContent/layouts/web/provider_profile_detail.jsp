                           ...
                           <c:if test="${model.isViewRate}">
	                			...
	                			<table width="100%" border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse">
		                       			<tr>
										    ...
										    <th scope="col">#</th>
										    <th scope="col">Nhà mạng / Loại giao dịch</th>
										...
										<!-- BANK -->
										<c:forEach items="${model.ls_bank_telco}" var="bank_telco" varStatus="i">
		                       				<c:if test="${i.count=='1'}">
				                       			<tr id="row-index-${i.index+1}" >
													<td class="svr_data" style="padding: 8px" align="center" rowspan="${model.ls_bank_telco_number}">
													...
													<td class="svr_data" style="padding: 8px" align="center">
														<span  id="td-nhamang-${i.index+1}" title="${onepay:getOperatorName(bank_telco.telco)}">${bank_telco.telco}</span>
													</td>
													<td class="svr_data" style="padding: 8px" align="center">
