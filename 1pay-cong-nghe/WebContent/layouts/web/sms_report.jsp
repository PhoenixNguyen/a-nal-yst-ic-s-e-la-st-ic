							...
							<div>
								<form id="smsReport" action="sms-report.html" method="post">
									<div id="dash_tab">
											...
											<a id="telco" href="<%=request.getContextPath() %>/protected/sms-report.html" class="tab_slc"><span>SMS Charging</span></a> 
									...
									<div id="filter_locketqua">
										...
										<div class="box_locketqua">
							                ...
							                <div class="filter_row">
							                 	<span class="add-on">Mã lệnh:</span>
               				...
               				<div class="srv_row">
								...
								<c:if test="${model.total > 0}">
									<a href="<%=request.getContextPath()%>/protected/export_sms_report.html?${model.export_parameter}" 
										class="export_link"><span>Export files</span></a>
									<script type="text/javascript">
										$(document).ready(function() {
               				...
               				<div class="srv_row">
								<display:table name="model.list" id="list" 
								    ...
								    <display:column title="Đầu số" headerClass="transhead" class="transdata" property="shortCode" style="border: 1px solid #CCC;text-align:right;" format="{0,number,0,000} đ" />
								    <display:column title="Đầu mã" headerClass="transhead" class="transdata" property="commandCode" style="border: 1px solid #CCC;" />
								    ...
								    <display:column title="CDR" headerClass="transhead" class="transdata" sortProperty="status" style="border: 1px solid #CCC;text-align:center;">
										<c:choose>
											...
											<c:otherwise>
												<img border="0" src="<%=request.getContextPath()%>/images/error.png" title="Không tính cước" />
											</c:otherwise>
										</c:choose>
								    </display:column>
