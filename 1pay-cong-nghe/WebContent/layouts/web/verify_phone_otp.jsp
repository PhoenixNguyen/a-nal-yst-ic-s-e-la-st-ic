				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div>
								Để lấy thông tin mã xác thực OTP bạn vui lòng kiểm tra tin nhắn SMS.
							</div>
							<div class="srv_row">
								<form name="activedOTP" action="<%=request.getContextPath() %>/protected/verify_phone_otp.html" method="post">
									...
									<div class="form_row">
										<input type="text"name="otp" class="txt_reglog is_numeric" title="Mã xác thực OTP" placeholder="Mã xác thực OTP" onfocus="clear(this)" maxlength="6"/>
