...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.pulsate.js"></script>
</head>
							...
							<h1 class="srv_title">Quản lý Merchant's Profile</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_approved.html" class="tab_slc"><span>Hiệu lực(${model.total_approved})</span></a>
									...
									<form id="list-sms-scenario" action="merchant_profile_approved.html" method="post">
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
														requestURI="merchant_profile_approved.html" 
										    ...
										    <display:column title="Charging" headerClass="transhead width110" class="transdata width90" style="border: 1px solid #CCC;">
										    	...
										    	<c:if test="${has_card_contract==1 && has_hardcopyCard==0}">
										    		<a title="Đã ký HĐ điện tử" class="pulsate">
										    ...
										    <display:column title="Actions" headerClass="transhead width80" class="svr_data1" style="border: 1px solid #CCC;">
												...
												<c:if test="${list.status==10}">
											    	...
											    	<a class="demo-wrapper html5-progress-bar">
														<progress id="${list.id}" name="progressbar" class="activate_profile_approve_" value="0" max="60" title="${model.statusTitleActivate[model.activateStatusIcon[activateIconKey]]}"></progress>
													</a>
													</c:if>
