							...
							<h1 class="srv_title">Quản lý Merchant's Profile</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_active.html" class="tab_slc"><span>Đang xử lý(${model.total_active})</span></a>
									...
									<form id="list-sms-scenario" action="merchant_profile_active.html" method="post">
										<jsp:include page="include_box_filter_merchant_profile_active.jsp"></jsp:include>
									</form>
				                 	</c:if>
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
														requestURI="merchant_profile_active.html" 
