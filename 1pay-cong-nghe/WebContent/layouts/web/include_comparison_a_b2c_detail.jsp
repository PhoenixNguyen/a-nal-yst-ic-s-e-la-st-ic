...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td width="50%"><strong>III -  Tổng doanh thu <span style="color: red"> [${model.comparison.merchant}]  </span> được hưởng còn lại (I-II):</strong></td>
  ...
  <tr>
    <td width="50%"><strong>IV -  Tổng số tiền 1PAY đã tạm ứng  <span style="color: red"> [${model.comparison.merchant}]  </span>  là:</strong></td>
  ...
  <tr>
    <td width="50%"><strong>V - Tổng số tiền 1PAY phải trả cho <span style="color: red">[${model.comparison.merchant}] </span>   là (III-IV):</strong></td>
