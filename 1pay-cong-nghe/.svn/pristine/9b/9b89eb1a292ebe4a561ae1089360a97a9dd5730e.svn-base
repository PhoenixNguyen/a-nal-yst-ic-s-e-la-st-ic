                			...
                			<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-color: #CCC">
                       		<tbody id="all_elecment_iac">
		                        ...
		                        <c:if test="${empty ls_iac_telco}">
		                        	<div style="color:#5CC16A; font-size: 14px;">IAC charging đang Sử dụng tỷ lệ default <a style="color: #0066cc;" href="<%=request.getContextPath() %>/protected/merchant_profile_detail.html?id=${profileId}">xem chi tiết tỷ lệ default ở đây</a></div>
