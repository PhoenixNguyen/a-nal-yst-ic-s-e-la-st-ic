...
{
	var answer = confirm("Bạn có muốn xóa tất cả tỷ lệ IAC Charging không?");
	if(answer){
					...
					<div class="row_sub">
                			...
                			<div class="srv_row">
												 	...
												 	<div class="product_slc_filter filter_row">
														<fieldset class="billing_info_detail" style="padding-bottom: 0">
															...
															<div style="padding: 0 2px;" class="clear">
								                                <div class="product_title">     
								                                    <label class="label_popup_profile">Phụ lục Iac charging:</label>
                				...
                				<table cellpadding="5" cellspacing="0">
									<tbody>
										...
										<tr>
											<td class="label_popup_profile">
												Address<span class="required_red">(*)</span>:
											</td>
											<td>
                        ...
                        <div id="charging_rates_private" style="display:none;">
              			<div id="dash_tab">
	                        ...
	                        <a href="#dash_tab" class="tab_common tab" title="iac_charging_id"><span>In-App Charging</span></a>
	                        <div class="clear"></div>
                    	</div>
                    	<!-- Tat ca -->
                    	...
                    	<div class="srv_row content" style="display: none;" id="iac_charging_id">
	                    	...
	                    	<table width="100%" cellspacing="0" cellpadding="0" >
	                    		<tr style="font-size: 9pt;">
									<td colspan="4" align="center">
									<div style="border: solid #ccc 1px;margin-bottom: 10px;padding: 5px;display: inline-block;">
	                            	<strong>Loại tỷ lệ IAC Charging:</strong>
                			...
                			<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border:1px solid #CCC;">
                       		<tbody id="all_elecment_iac">
		                        ...
		                        <c:if test="${empty ls_iac_telco}">
		                        	<%-- <c:if test="${!isDefaultRatesOfChargingIAC}">
		                        		<div style="color:red; font-size: 14px;">(IAC charging chưa ký hợp đồng điện tử)</div>
		                        	</c:if> --%>
                     		...
                     		<div class="srv_row IacChargingTypeRateCommon" style="padding: 0;">
               				...
               				<c:if test="${chargingServices['IAC'] == null}">
	                       		<div align="right" style="color:red; font-size: 14px;margin-bottom: 10px;">(Iac charging chưa ký hợp đồng điện tử)</div>
	                       	</c:if>
	                       	<c:if test="${chargingServices['IAC'] != null}">
	                       		<div align="right" style="color:#2c8f39; font-size: 14px;margin-bottom: 10px;">(Iac charging đã ký hợp đồng điện tử)</div>
	                       	</c:if> 
                    	</div>
                    	<!-- /InApp -->
                    	</div>
                    	...
                    	<div id="dash_tab">
	                        ...
	                        <a href="#dash_tab" class="tab_common tab" title="default_iac_charging_id"><span>In-App Charging</span></a>
	                        <div class="clear"></div>
                    	</div>
                    	<!-- Telco of CARD service -->
	                      	...
	                      	<a href="${call_back_url}" class="btn_graysmall">Hủy bỏ</a>
	                      		...
	                      		$(document).ready(function() {
									...
									$('#preview_merchant_profile').live('click', function() {
										...
										$(".popup_hasHardIacCopy").html('<input type="checkbox"' + ($('input[name=hasHardIacCopy]').is(':checked') ? ' checked="checked"' : '') + ' disabled="true" /> <a href="' + ($('.hardIacCopyLink').attr('href') ? $('.hardIacCopyLink').attr('href'):'#') + '" class="' + ($('.hardIacCopyLink').attr('href') ? 'hard_link':'') + '" style="font-size: 14px;">Iac</a>');
