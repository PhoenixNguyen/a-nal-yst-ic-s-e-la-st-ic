																...
																<td class="svr_data">
																	<table cellpadding="0" cellspacing="0" width="100%" border="0">
																		<tr>
																			...
																			<td>
																				<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'merchant',item.merchant) }"><strong><c:out value="${item.merchant }" />
																...
																<td class="svr_data">
																	<table cellpadding="0" cellspacing="0" width="100%" border="0">
																		<tr>
																			...
																			<td>
																				<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'paymentProvider',item.paymentProvider) }"><strong><c:out value="${onepay:providerCode2Text(item.paymentProvider) }" /></strong></a>
																			</td>
																		</tr>
																	</table>
																</td>
																...
																<td class="svr_data">
																	<table cellpadding="0" cellspacing="0" width="100%" border="0">
																		<tr>
																			...
																			<td>
																				<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'merchantPolicy',item.merchantPolicy) }"><strong><c:out value="${onepay:merchantPolicyCode2Text(item.merchantPolicy) }" /></strong></a>
																			</td>
																		</tr>
																	</table>
																</td>
																	...
																	<table cellpadding="0" cellspacing="0" width="100%" border="0">
																		<tr>
																			<td width="13" style="padding-right: 5px;">
																				...
																				value="${item.merchantPolicy}" class="chck_svr" /></td>
																			<td>
																				<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'merchantContract',item.merchantContract) }"><strong><c:out value="${onepay:merchantContractCode2Text(item.merchantContract) }" /></strong></a>
																			</td>
																		</tr>
																	</table>
																</td>
																	...
																	<td class="svr_data">
																		<table cellpadding="0" cellspacing="0" width="100%" border="0">
																			<tr>
																				...
																				<td>
																					<a href="<%=request.getContextPath()%>/protected/revenue-dashboard.html?${onepay:setParam(pageContext.request.queryString,'chargingService',item.chargingService) }"><strong><c:out value="${onepay:chargingServiceCode2Text(item.chargingService)}" /></strong></a>
																				</td>
																			</tr>
																		</table>
																	</td>
