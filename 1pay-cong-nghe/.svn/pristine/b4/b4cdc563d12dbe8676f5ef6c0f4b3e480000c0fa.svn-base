					...
					<div class="log_reg_container">
						...
						<div class="reg_form">
							<form:form name="registration" commandName="forgot_password" method="post">
								...
								<div class="form_row">
									<form:input path="account" cssClass="txt_reglog" title="Tài khản hoặc Email đăng ký" placeholder="Tài khoản hoặc Email đăng ký" onfocus="clear(this)" />
								</div>
								...
								<div class="form_row">
									<div class="clear"></div>
									<form:input path="verifyCode" cssClass="txt_reglog" title="Mã xác nhận" placeholder="Nhập mã xác nhận" onfocus="clear(this)" />
								</div>
