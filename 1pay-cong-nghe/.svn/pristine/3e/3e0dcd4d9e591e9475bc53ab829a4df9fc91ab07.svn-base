...
<div id="wrapper"> 
    ...
    <div class="layout_1000"> 
        ...
        <div class="hdr_02">
            ...
            <tbody>
                  <tr>
                  <td><a class="link_xemhd_invi" title="Review contract & provide your information"></a>
                      <h2>1. Sample contract</h2>
                      <p>Download PDF file to review sample contract</p></td>
                <td><a class="link_xacnhanhd_invi" title="Review contract & provide your information"></a>
                      <h2>2. Confirmation</h2>
                      <p>Provide your information to process contract</p></td>
                <td>
                <a class="link_kyhd_invi" title="Signed E-Contract"></a>
                      <h2>3. Sign E-Contract</h2>
                      <p>Click <strong>Sign</strong> to complete signing e-contract.</p></td>
                <td><a class="link_taihd_focus" href="<%=request.getContextPath() %>/protected/hop-dong.html" title="Download your signed contract"></a>
                ...
                <div class="hdr_data">
                    <div class="form_row">
                        	<div class="form_linktai_title">
                            	E-contract has been completed. Thank you for using 1Pay service!
                            </div>
                            
                        </div>
                        <div class="form_row">You can download signed contract to your computer</div>
                        <div class="form_row">
                        	<div><a href="<%=request.getContextPath() %>/protected/wap_constract.html" class="link_taihopdong">Download signed e-contract</a></div>
                        </div>
                        
                        <div class="form_row">
                        	<a href="<%=request.getContextPath() %>/dich-vu.html" class="btn_back">Return to service</a>
                        </div>
