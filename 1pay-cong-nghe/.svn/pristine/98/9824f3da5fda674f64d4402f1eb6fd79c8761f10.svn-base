							...
							<h1 class="srv_title">Quản lý Merchant's Profile</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_reject.html" class="tab_slc"><span>Bị hủy(${model.total_reject})</span></a>
										<!-- 
										...
										<a href="<%=request.getContextPath() %>/protected/merchant-profile-help.html" style="float:right;margin-right: 10px;" target="_blank"><img src="<%=request.getContextPath() %>/images/user_help.png" alt="Merchant Profile Help" width="24px" /></a>
										<div class="clear"></div>
									</div>
									<c:if test="${model.isStaff}">
									<form id="list-sms-scenario" action="merchant_profile_reject.html" method="post">
										<jsp:include page="include_box_filter_merchant_profile_reject.jsp"></jsp:include>
									</form>
									</c:if>
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
														requestURI="merchant_profile_reject.html" 
										    ...
										    <display:column title="Chu kỳ TT" headerClass="transhead " class="transdata width70" style="border: 1px solid #CCC;text-align:center;">
										    	${onepay:merchantPolicyCode2ShortText(list.contractInfo.paymentPolicy)}
										    </display:column>
										    <display:column title="Charging" headerClass="transhead width110" class="transdata width90" style="border: 1px solid #CCC;">
										    	<c:set var="has_card" value="0" />
										    	<c:set var="has_sms" value="0" />
										    	<c:set var="has_wap" value="0" />
										    	<c:set var="has_iac" value="0" />
										    	<c:set var="has_bank" value="0" />
										    	<c:forEach items="${list.merchantChargingRate.chargingRates}" var="chargingRate">
										    		<c:if test="${(!list.merchantChargingRate.is_default) && chargingRate.key=='CARD'}">
										    				<c:set var="has_card" value="1" />
													</c:if>
										    		<c:if test="${(!list.merchantChargingRate.is_default) && chargingRate.key=='SMS'}">
										    				<c:set var="has_sms" value="1" />
										    		</c:if>
										    		<c:if test="${(!list.merchantChargingRate.is_default) && chargingRate.key=='WAP'}">
										    				<c:set var="has_wap" value="1" />
										    		</c:if>
										    		<c:if test="${(!list.merchantChargingRate.is_default) && chargingRate.key=='IAC'}">
										    				<c:set var="has_iac" value="1" />
										    		</c:if>
										    		<c:if test="${(!list.merchantChargingRate.is_default) && chargingRate.key=='BANK'}">
										    				<c:set var="has_bank" value="1" />
										    		</c:if>
										    	</c:forEach>
										    	...
										    	<c:set var="has_bank_contract" value="0" />
										    	<c:set var="has_hardcopyCard" value="0" />
										    	<c:set var="has_hardcopySms" value="0" />
										    	<c:set var="has_hardcopyWap" value="0" />
										    	<c:set var="has_hardcopyIac" value="0" />
										    	<c:set var="has_hardcopyBank" value="0" />
										    	<c:if test="${list.contractInfo.hasHardCardCopy}">
										    		<c:set var="has_hardcopyCard" value="1" />
												</c:if>
												<c:if test="${list.contractInfo.hasHardSmsCopy}">
										    		<c:set var="has_hardcopySms" value="1" />
												</c:if>
												<c:if test="${list.contractInfo.hasHardWapCopy}">
										    		<c:set var="has_hardcopyWap" value="1" />
												</c:if>
												<c:if test="${list.contractInfo.hasHardIacCopy}">
										    		<c:set var="has_hardcopyIac" value="1" />
												</c:if>
												<c:if test="${list.contractInfo.hasHardBankCopy}">
										    		<c:set var="has_hardcopyBank" value="1" />
												</c:if>
										    	...
										    	<c:forEach items="${list.contractInfo.chargingServices}" var="chargingService">
										    		...
										    		<c:if test="${chargingService.key=='BANK'}">
										    				<c:set var="has_bank_contract" value="1" />
										    		</c:if>
										    	</c:forEach>
										    	
										    	<!-- Tỷ lệ -->
										    	<c:if test="${has_card==0 && has_card_contract==0}">
										    	...
										    	<c:if test="${has_sms==0 && has_sms_contract==0}">
										    	...
										    	<c:if test="${has_wap==0 && has_wap_contract==0}">
										    	...
										    	<c:if test="${has_iac==0 && has_iac_contract==0}">
										    	...
										    	<c:if test="${has_bank==0 && has_bank_contract==0}">
										    		<img src="../images/bank_invi.png" alt="" class="wap_invi"/>
										    	</c:if>
										    	<c:if test="${has_bank==1}">
										    		<a title="Đã sử dụng dịch vụ BANK"><img src="../images/bank_normal.png" alt="" class="wap_invi"/></a>
										    	</c:if>
										    	<c:if test="${has_bank==0 && has_bank_contract==1}">
										    		<img src="../images/bank_normal_active.png" alt="" class="wap_invi"/>
										    	</c:if>
										    	<!-- Tỷ lệ -->
										    	
										    	<br/>
										    	<!-- HD điện tử & HĐ bản cứng -->
										    	<c:if test="${has_card_contract==0}">
										    		<img src="../images/contract_no.png"/>
										    	</c:if>
										    	<c:if test="${has_card_contract==1 && has_hardcopyCard==0}">
										    		<a title="Đã ký HĐ điện tử">
										    			<img src="../images/contract_yes.png"/>
										    		</a>
										    	</c:if>
										    	<c:if test="${has_card_contract==1 && has_hardcopyCard==1}">
										    		<a title="Đã ký HĐ điện tử & Có phụ lục">
										    			<img src="../images/contract_hardcopy.png"/>
										    		</a>
										    	</c:if>
										    	...
										    	<c:if test="${has_sms_contract==1 && has_hardcopySms==0}">
										    		<a title="Đã ký HĐ điện tử">
										    			<img src="../images/contract_yes.png"/>
										    		</a>
										    	</c:if>
										    	<c:if test="${has_sms_contract==1 && has_hardcopySms==1}">
										    		<a title="Đã ký HĐ điện tử & Có phụ lục">
										    			<img src="../images/contract_hardcopy.png"/>
										    		</a>
										    	</c:if>
										    	...
										    	<c:if test="${has_wap_contract==1 && has_hardcopyWap==0}">
										    		<a title="Đã ký HĐ điện tử">
										    			<img src="../images/contract_yes.png"/>
										    		</a>
										    	</c:if>
										    	<c:if test="${has_wap_contract==1 && has_hardcopyWap==1}">
										    		<a title="Đã ký HĐ điện tử & Có phụ lục">
										    			<img src="../images/contract_hardcopy.png"/>
										    		</a>
										    	</c:if>
										    	...
										    	<c:if test="${has_iac_contract==1 && has_hardcopyIac==0}">
										    		<a title="Đã ký HĐ điện tử">
										    			<img src="../images/contract_yes.png"/>
										    		</a>
										    	</c:if>
										    	<c:if test="${has_iac_contract==1 && has_hardcopyIac==1}">
										    		<a title="Đã ký HĐ điện tử & Có phụ lục">
										    			<img src="../images/contract_hardcopy.png"/>
										    		</a>
										    	</c:if>
										    	
										    	<c:if test="${has_bank_contract==0}">
										    		<img src="../images/contract_no.png"/>
										    	</c:if>
										    	<c:if test="${has_bank_contract==1 && has_hardcopyBank==0}">
										    		<a title="Đã ký HĐ điện tử">
										    			<img src="../images/contract_yes.png"/>
										    		</a>
										    	</c:if>
										    	<c:if test="${has_bank_contract==1 && has_hardcopyBank==1}">
										    		<a title="Đã ký HĐ điện tử & Có phụ lục">
										    			<img src="../images/contract_hardcopy.png"/>
										    		</a>
										    	</c:if>
										    ...
										    <display:column title="Actions" headerClass="transhead" class="svr_data1" style="border: 1px solid #CCC;">
										    	...
										    	<!-- Clone profile -->
										    	<%-- <c:if test="${onepay:viewCloneMerchantProfile(list.status, list.activate) =='true'}">
										    		<a class="act_copylink clone_profile" id="${list.id}" title="Clone profile"></a>
										    	</c:if> --%>
										    	<c:if test="${onepay:viewCloneMerchantProfile(list.status, list.activate) =='true'}">
										    		<a class="act_copylink clone_profile${(list.childReference != null && fn:length(list.childReference) > 0) ? ' act_copylink_has_child' : ''}" id="${list.id}" title="Clone profile"></a>
										    	</c:if>
										    	<!-- /Clone profile -->
												...
												<c:if test="${list.status==10}">
											    	...
											    	<c:if test="${list.activate=='Pending'||list.activate=='Rejected'}">
										    	...
										    	<%if(account.checkRole(Account.ACCOUNT_STAFF_ROLE)||account.checkRole(Account.ACCOUNT_MERCHANT_ROLE)){ %>
													<c:if test="${list.status==10}">
												    	<c:set var="activateIconKey" value="com${list.id}" />
														<a id="${list.id}" style="display: inline-block;" class="demo-wrapper html5-progress-bar ${(list.activate=='ready' || list.activate=='destroy')? 'activate_profile_approve_' : 'activate_reject'}" title="${model.statusTitleActivate[model.activateStatusIcon[activateIconKey]]}">
												...
												<input type="hidden" id="hd_proposedDateFmt-${list.id}" value="${list.proposedDateFmt}"/>
												...
												<input type="hidden" id="hd_hasHardCardCopy-${list.id}" value="${list.contractInfo.hasHardCardCopy}"/>
												<input type="hidden" id="hd_hasHardSmsCopy-${list.id}" value="${list.contractInfo.hasHardSmsCopy}"/>
												<input type="hidden" id="hd_hasHardWapCopy-${list.id}" value="${list.contractInfo.hasHardWapCopy}"/>
												<input type="hidden" id="hd_hasHardIacCopy-${list.id}" value="${list.contractInfo.hasHardIacCopy}"/>
												<input type="hidden" id="hd_hasHardBankCopy-${list.id}" value="${list.contractInfo.hasHardBankCopy}"/>
												<input type="hidden" id="hd_linkHardCardCopy-${list.id}" value="${list.contractInfo.hardCardContractFile}"/>
												<input type="hidden" id="hd_linkHardSmsCopy-${list.id}" value="${list.contractInfo.hardSmsContractFile}"/>
												<input type="hidden" id="hd_linkHardWapCopy-${list.id}" value="${list.contractInfo.hardWapContractFile}"/>
												<input type="hidden" id="hd_linkHardIacCopy-${list.id}" value="${list.contractInfo.hardIacContractFile}"/>
												<input type="hidden" id="hd_linkHardBankCopy-${list.id}" value="${list.contractInfo.hardBankContractFile}"/>
												<input type="hidden" id="hd_hasCardContract-${list.id}" value="${list.contractInfo.chargingServices['CARD']!=null?'1':'0'}"/>
												<input type="hidden" id="hd_hasSmsContract-${list.id}" value="${list.contractInfo.chargingServices['SMS']!=null?'1':'0'}"/>
												<input type="hidden" id="hd_hasWapContract-${list.id}" value="${list.contractInfo.chargingServices['WAP']!=null?'1':'0'}"/>
												<input type="hidden" id="hd_hasIacContract-${list.id}" value="${list.contractInfo.chargingServices['IAC']!=null?'1':'0'}"/>
												<input type="hidden" id="hd_hasBankContract-${list.id}" value="${list.contractInfo.chargingServices['BANK']!=null?'1':'0'}"/>
												<input type="hidden" id="hd_version-${list.id}" value="${list.version}"/>
												<input type="hidden" id="hd_startDateFmt-${list.id}" value="${list.startDateFmt}"/>
												<input type="hidden" id="hd_clone_reason-${list.id}" value="${onepay:getMerchantProfileLogs(list.reference, 'manager_profile_clone_profile', pageContext.request)}"/>
												...
												<!-- Billing Info -->
												<input type="hidden" id="hd_billing_type-${list.id}" value="${onepay:billingType2Text(list.billingInformation.billing_type)}"/>
										    	...
										    	<input type="hidden" id="hd_childReference-${list.id}" value="${list.childReference}"/>
										    	<!-- /reference -->
												</c:set>
												<textarea style="display:none;" id="data_${list.id}">${onepay:base64Encode(data)}</textarea>
										    </display:column>	
										</display:table>
