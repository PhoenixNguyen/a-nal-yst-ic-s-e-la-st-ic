...
<div id="wrapper"> 
    ...
    <div class="layout_1000"> 
          ...
          <div id="w_body">
      		...
      		<jsp:include page="include_bank_contract_info_header.jsp"></jsp:include>
        ...
        <div class="hdr_02">
            ...
            <tbody>
                ...
                <td>
                <a class="link_kyhd_focus" title="Ký hợp đồng điện tử"></a>
                      <h2>3. Ký hợp đồng điện tử</h2>
                      <p>Chọn <strong>Ký hợp đồng</strong> để hợp thức hóa hợp đồng điện tử.</p></td>
                <td><a class="link_taihd_invi" title="Tải xuống hợp đồng đã ký"></a>
            ...
            <form action="<%=request.getContextPath() %>/protected/bank_contract_step_04.html">
            <div class="hdr_03">
                <div class="hdr_data">
                    <div class="form_row">
                        ...
                        <div class="form_row">	
                        	<input value="Ký hợp đồng" class="btn_nextstep" type="submit"/>
                            <input value="Hủy" class="btn_huyhd" type="button" onclick="location.href='<%=request.getContextPath() %>/dich-vu.html'"/>
                        </div>
                </div>
            </div>
            </form>
