...
<div id="wrapper"> 
    ...
    <div class="layout_1000"> 
        ...
        <div class="hdr_02">
            ...
            <tbody>
                  <tr>
                  <td><a class="link_xemhd_invi" href="<%=request.getContextPath() %>/protected/card_contract_step_01.html" title="Review contract & provide you information"></a>
                      <h2>1.Sample contract</h2>
                      <p>Download PDF file to review sample contract</p></td>
                <td><a class="link_xacnhanhd_invi" href="#" title="Review contract & provide you information"></a>
