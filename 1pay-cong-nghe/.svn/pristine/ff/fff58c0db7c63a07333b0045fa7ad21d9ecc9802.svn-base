							...
							<h1 class="srv_title">Merchant Manager</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_ready.html" class="tab_slc"><span>Sẵn sàng(${model.total_ready})</span></a>
									...
									<c:if test="${model.total>0 }">
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
										    ...
										    <display:column title="Actions" headerClass="transhead width150" class="svr_data1" style="border: 1px solid #CCC;">
										    	<a href="merchant_profile_detail.html?id=${list.id}" class="act_detail" title="Xem Merchant Profile" target="blank"></a>
