											...
											<div class="filter_row">
								                ...
								                <div style="display: block; float: right;">
								                 	...
								                 	<select id="status" name="status" class="dashboard_filter">
								                 		...
								                 		<option value="1" ${(param.status == '1')?'selected="selected"':''}>1-Hủy đề nghị duyệt sơ bộ</option>
								                 		<option value="2" ${(param.status == '2')?'selected="selected"':''}>2-Chờ duyệt sơ bộ</option>
								                 		<option value="3" ${(param.status == '3')?'selected="selected"':''}>3-Bị hủy duyệt sơ bộ</option>
								                 		<option value="4" ${(param.status == '4')?'selected="selected"':''}>4-Chờ merchant xác nhận</option>
								                 		<option value="5" ${(param.status == '5')?'selected="selected"':''}>5-Merchant hủy xác nhận</option>
								                 		<option value="6" ${(param.status == '6')?'selected="selected"':''}>6-Chờ duyệt chính thức</option>
								                 		<option value="7" ${(param.status == '7')?'selected="selected"':''}>7-Hủy duyệt chính thức</option>
								                 		<option value="8" ${(param.status == '8')?'selected="selected"':''}>8-Chờ thanh toán</option>
								                 		<option value="9" ${(param.status == '9')?'selected="selected"':''}>9-Hủy thanh toán</option>
								                 		<option value="10" ${(param.status == '10')?'selected="selected"':''}>10-Đã thanh toán</option>
								                 		<option value="11" ${(param.status == '11')?'selected="selected"':''}>11-Merchant hủy xác nhận đã thanh toán</option>
								                 		<option value="12" ${(param.status == '12')?'selected="selected"':''}>12-Merchant đã xác nhận thanh toán</option>
								                 	</select>
								                </div>
								                </c:if>
							                </div>
