...
<div id="wrapper"> 
    ...
    <div class="layout_1000"> 
        ...
        <div class="hdr_02">
            ...
            <tbody>
                  <tr>
                  <td><a class="link_xemhd_focus" title="Review contract & provide your information"></a>
                ...
                <td><a class="link_taihd_invi" href="hopdongdientu_step_04.html" title="Download your signed contract"></a>
            ...
            <div class="hdr_03">
            	<div class="form_row">Please review this sample contract before fulfill your information</div>
            	<div class="hdr_data"><a href="<%=request.getContextPath() %>/hop-dong-mau.html" class="link_taihopdong" target="_blank">Link to download sample contract  </a></div>
                
                <div class="form_row">	
                     <input value="Next step" class="btn_nextstep" type="button" onclick="location.href='<%=request.getContextPath() %>/protected/sms_contract_step_02.html'"/>
                 </div>
            </div>
      </div>
