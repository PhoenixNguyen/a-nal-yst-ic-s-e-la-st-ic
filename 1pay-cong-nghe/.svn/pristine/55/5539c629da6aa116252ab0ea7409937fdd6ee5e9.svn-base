...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td width="50%"><strong>II - Tổng số tiền [${model.comparison.merchant}] được hưởng từ chiết khấu đặc biệt là (II.1+II.2+II.3): </strong></td>
  ...
  <tr>
    <td width="50%"><strong>III - Tổng doanh thu  <span style="color: red"> [${model.comparison.merchant}]  </span>  được hưởng (I+II):</strong></td>
  ...
  <tr>
    <td width="50%"><strong>IV - Các chi phí [${model.comparison.merchant}] bị giảm trừ là (IV.1+IV.2+IV.3+IV.4): </strong></td>
  ...
  <tr>
    <td width="50%"><strong>V -  Tổng doanh thu <span style="color: red"> [${model.comparison.merchant}]  </span> được hưởng còn lại (III-IV):</strong></td>
  ...
  <tr>
    <td width="50%"><strong>VI -  Tổng số tiền 1PAY đã tạm ứng  <span style="color: red"> [${model.comparison.merchant}]  </span>  là:</strong></td>
  ...
  <tr>
    <td width="50%"><strong>VII - Tổng số tiền 1PAY phải trả cho <span style="color: red">[${model.comparison.merchant}] </span>   là (V-VI):</strong></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td width="60%" align="center">
    	<table width="100%" border="0" cellspacing="0" cellpadding="5">
        	<tr>
            	<td style="padding-bottom: 200px"><strong>Giám đốc điều hành</strong></td>
