...
function clickFirstButton(){
  ...
  if($("#dk").val() == undefined || jQuery.trim($("#dk").val()) == '')
	{
		alert("You have not entered conditions yet");
		$("#dk").focus();
		return ;
	}
  if($("#mt").val() == undefined || jQuery.trim($("#mt").val()) == '')
	{
		alert("You have not enter MT");
		$("#mt").focus();
		return ;
	}
  //An Form them moi
	...
	if(true)
	{
		...
		if($('input[name=hd_size]').size()==0)
		{
			html_ret += '<tr id="title_table_dk">';
				...
				html_ret += '<td class="transhead" width="120">Condition</td>';
				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							<h1 class="srv_title">SMS - Create MO core URL</h1>
							<div class="srv_row">
								...
								<table cellpadding="10" cellspacing="0" width="100%" class="api_access_tbl">
									<tbody>
										...
										<tr>
											<td class="profile_label" width="140" valign="top">Default MT<span class="red">(&#42;)</span>:</td>
											<td>
										...
										<tr>
											<td class="profile_label" width="140" valign="top">Service description:</td>
											<td>
							    ...
							    <br/>
							    <div id="">
									<h3 class="filter_label_ close box_locketqua_hide"><a href="#">Create service</a></h3>
								</div>
								<!-- Them DK -->
								<div class="box_locketqua" style="display: none;">
									...
									<tbody>
										<tr>
											<td class="profile_label" width="140" valign="top">Arrived MO<span class="red">(&#42;)</span>:</td>
											<td>
												<form:input path="dk"  class="txt_filter" placeholder="Inbox SMS contain keywords" onfocus="clear(this)" />
											</td>
										</tr>
										<tr>
											<td class="profile_label" width="140" valign="top">Returned MT<span class="red">(&#42;)</span>:</td>
											<td>
												<form:textarea path="mt"  placeholder="Correlative MT contents returned" onfocus="clear(this)" rows="3" cols="42"/>
											</td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td><input class="btn_greensmall" id="themdieukien" value="Add" type="button" onclick="clickFirstButton()"/></td>
										</tr>
									</tbody>
									</table>
				                </div>
				                <!-- /Them DK -->
								<input id="form-action-cabinet-save" value="Update" class="btn_greensmall" type="submit"/>
								<a href="<%=request.getContextPath()%>/protected/list-sms-scenario.html" class="btn_graysmall">Cancel</a>
							</div>
						</div>
						</form:form>
					</div>
