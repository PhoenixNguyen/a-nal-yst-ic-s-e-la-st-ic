				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
			                ...
			                <h1 class="srv_title">Manager merchants</h1>
			                <%
							...
							%>
							<div class="dash_row">
								<a href="<%=request.getContextPath()%>/protected/assign-merchant.html" class="addproduct_link"><span>Merchant allocation</span></a>
								<a href="<%=request.getContextPath()%>/account-permission-manager/change_permission.htm" class="addproduct_link" style="margin-right: 4px;"><span>Merchant decentralization</span></a>
							</div>
			                <div class="dash_row">
