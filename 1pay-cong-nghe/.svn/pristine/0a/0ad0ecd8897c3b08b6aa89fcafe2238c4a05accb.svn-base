				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
								<h1 class="srv_title">
									Hợp đồng của merchant ${model.merchantContract.merchant}
									<!-- 
									<%if(account.checkRole(Account.ACCOUNT_STAFF_ROLE)){ %>
										<a class="link_edit" href="<%=request.getContextPath() %>/protected/edit_merchant_contract.html?id=${model.merchantContract.id}" style="float:right;">[Sửa]</a>
									<%} %>
									 -->
								</h1>
