				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							...
							<div>
								<form id="iacReport" action="iac-report.html" method="post">
									<div id="dash_tab">
											<a id="cont" href="<%=request.getContextPath() %>/protected/card-report.html" class="tab"><span>Card Charing</span></a>
											<a id="price" href="<%=request.getContextPath() %>/protected/sms-report.html" class="tab"><span>SMS Charing</span></a> 
											<a id="price" href="<%=request.getContextPath() %>/protected/wap-report.html" class="tab"><span>WAP Charing</span></a>
											<a id="telco" href="<%=request.getContextPath() %>/protected/iac-report.html" class="tab_slc"><span>In-App Charing</span></a>
											<div class="clear"></div>
									</div>
									<div id="filter_locketqua">
										...
										<div class="box_locketqua">
							                ...
							                <div class="filter_row">
							                 	<span class="add-on">Game code:</span>
               				...
               				<div class="srv_row">
								...
								<display:table name="model.list" id="list" 
								    ...
								    <display:column title="Subscriber" headerClass="transhead" class="transdata" property="telco" style="border: 1px solid #CCC;" />
								    <display:column title="Subscriber" headerClass="transhead" class="transdata" property="msisdn" style="border: 1px solid #CCC;" />
								    <display:column title="Game code" headerClass="transhead" class="transdata" property="command" style="border: 1px solid #CCC;" />
								    ...
								    <display:column title="Status" headerClass="transhead" class="transdata" sortProperty="status" style="border: 1px solid #CCC;text-align:center;">
										<c:choose>
											...
											<c:otherwise>
												<img border="0" src="<%=request.getContextPath()%>/images/error.png" class="error_icon" title='${empty list.merchantRespMessage ? 'Unsuccess': list.merchantRespMessage }' />
											</c:otherwise>
										</c:choose>
								    </display:column>
								</display:table>
