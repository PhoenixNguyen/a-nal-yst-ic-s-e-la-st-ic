							...
							<h1 class="srv_title">Quản lý Merchant's Profile</h1>
								<div>
									<div id="dash_tab">
										...
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_approved.html" class="tab_slc"><span>Đã kích hoạt</span></a>
										<a href="<%=request.getContextPath() %>/protected/merchant_profile_rejected.html" class="tab"><span>Chưa kích hoạt</span></a>
				                 	...
				                 	<div class="srv_row">
										...
										<display:table name="model.list" id="list" 
										    ...
										    <display:column title="Actions" headerClass="transhead width130" class="svr_data1" style="border: 1px solid #CCC;">
										    	<a href="merchant_profile_detail.html?id=${list.merchant}" class="act_detail" title="see Merchant Profile" target="blank"></a>
