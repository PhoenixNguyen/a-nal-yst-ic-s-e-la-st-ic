...
<!-- Yeu cau Duyet so bo -->
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="require_preliminary_approve_post">
		...
		<div class="pop_box">
			...
			<div class="product_title">
				Report period: <span class="go_sms_product_name popup_payment_policy" id="popup_payment_policy"></span>
			</div>
			<div class="product_title">
				Contract type: <span class="go_sms_product_name popup_has_vat" id="popup_has_vat"></span>
			</div>
			<div class="product_title">
				Kỳ đối soát: <span class="go_sms_product_name popup_title" id="popup_title"></span>
			</div>
			<div class="product_title">
				Status Report: <span class="go_sms_product_name popup_status_view" id="popup_status_view"></span>
			</div>
			<div class="product_title">
				Description: <span class="go_sms_product_name popup_reject_log" id="popup_reject_log"></span>
			</div>
			<div class="product_title">
				Revenue sharing: <span class="go_sms_product_name popup_amount_total" id="popup_amount_total"></span>
			</div>
			<div class="product_title">
		...
		<div>
			...
			<input name="reset" value="Reset" class="btn_graysmall modal_close" type="reset"/>
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="preliminary_approve_post">
		...
		<div class="pop_box">
			...
			<div class="li_row">
				<b>Description/lý do hủy bỏ:</b>
				<br>
				<textarea id="popup_des" name="popup_des" rows="10" cols="50" placeholder="Description/lý do hủy bỏ"></textarea>
			</div>
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="merchant_confirm_post">
		...
		<div class="pop_box">
			...
			<div class="li_row">
				<b>Description/lý do hủy bỏ:</b>
				<br>
				<textarea id="popup_des_merchant" name="popup_des" rows="10" cols="50" placeholder="Description/lý do hủy bỏ"></textarea>
			</div>
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="offical_post">
		...
		<div class="pop_box">
			...
			<div class="li_row">
				<b>Description/lý do hủy bỏ:</b>
				<br>
				<textarea id="popup_des_offical" name="popup_des" rows="10" cols="50" placeholder="Description/lý do hủy bỏ"></textarea>
			</div>
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="billing_post">
		...
		<div class="pop_box">
			...
			<div class="li_row">
				<b>Description/lý do hủy bỏ:</b>
				<br>
				<textarea id="popup_des_billing" name="popup_des" rows="10" cols="50" placeholder="Description/lý do hủy bỏ"></textarea>
			</div>
	...
	<form action="<%=request.getContextPath()%>/protected/comparison_app_ajax.html" method="post" name="merchant_confirm_bill_post">
		...
		<div class="pop_box">
			...
			<div class="li_row">
				<b>Description/lý do hủy bỏ:</b>
				<br>
				<textarea id="popup_des_merchant_bill" name="popup_des" rows="10" cols="50" placeholder="Description/lý do hủy bỏ"></textarea>
			</div>
...
function getStatusDescription(active) {
	...
	return status_view;
											...
											$(document).ready(function() {
												$("#myTip").qtip({
													content: 'Revenue sharing (Ký hiệu DT): là doanh thu 1PAY bắt đầu dùng để chia sẻ từ các dịch vụ hai bên hợp tác sau khi trừ đi thuế VAT (10%). Phần thuế VAT 10% 1PAY phải nộp vào ngân sách nhà nước.',										
													position : {
														corner : {
															target : 'topRight',
															tooltip : 'bottomLeft'
		...
		$(document).ready(function() {
			$('.export_info').live('click', function() {
				if($('input[name=contractType]:checked').length == 0 || $('input[name=contractType]:checked').length > 1) {
					alert('Bạn phải chọn 1 Contract type');
					$('.modal_close').click();
					return false;
				}
				
				if($('select[name=paymentPolicy]').val().length <= 0) {
					alert('Bạn phải chọn 1 Report period');
					$('.modal_close').click();
					return false;
				}
