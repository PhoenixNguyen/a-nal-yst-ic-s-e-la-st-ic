				...
				<div id="w_body">
					<div class="log_reg_container">
						<div class="reg_form" style="width:100%;">
								<div class="form_row">
									<div class="form_title" style="width: 100%;">Results of getting back password</div>
									<div class="clear"></div>
								</div>
								<div class="form_row">
									Congratulation ! you have successfully get back the password for the account of <b>${username}</b>
								</div>
								<div class="clear"></div>
								<div class="clear"></div>
