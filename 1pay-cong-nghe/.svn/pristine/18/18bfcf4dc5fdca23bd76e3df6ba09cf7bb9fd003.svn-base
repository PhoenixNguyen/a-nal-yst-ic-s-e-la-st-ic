                                ...
                                <div class="product_slc_filter filter_row">
									<fieldset class="identity_verify_popup">
										...
										<div style="padding: 2px;">
											<div class="contract_content">     
			                                    <label class="label_popup_edit_contact">CMND/ĐKKD: </label>
			                                    <span class="go_sms_product_name popup_common_identity__identity"></span>
			                                </div> 
			                                <div class="contract_content"> 
			                                	<label class="label_popup_edit_contact"> &nbsp; </label>
			                                	<a class="popup_common_identity_image_a" href="<%=request.getContextPath()%>/images/identity_no.jpg" class="top_up" toptions="overlayClose=1, width = 900, height = 600, type = flash, title = Bản mềm CMND/Đăng ký Kinh doanh, effect=transform, shaded=1, ondisplay = open_win()">
													<img class="popup_common_identity_image" border="0" width="100" height="50" src="<%=request.getContextPath()%>/images/identity_no.jpg"/>
												</a>
			                                </div>
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Nơi cấp CMND/Địa chỉ ĐKKD: </label>
			                                	<span class="go_sms_product_name popup_common_identity_place_of_issue"></span>
			                                </div> 
			                                <div class="contract_content"> 
			                                	<label class="label_popup_edit_contact">Ngày cấp: </label>
			                                	<span class="go_sms_product_name popup_common_identity_date_of_issue"></span>
			                                </div>
										</div>
									</fieldset>
								</div>
                                 ...
                                 <div class="product_slc_filter filter_row">
									<fieldset class="billing_info_popup">
										<legend>
											...
											<span class="button_veriry_billing_infomation">
		                                		[<a href="<%=request.getContextPath()%>/protected/billing_info_verify.html" target="_blank" class="link_feature" title="Xác thực thông tin thanh toán" style="color: #0066cc">Xác thực</a>]
		                                	</span>
											</strong>
										</legend>
										<div style="padding: 2px;">
											<div class="contract_content">     
			                                    ...
			                                    <span class="go_sms_product_name popup_billing_info_account_holder"></span>
			                                </div> 
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Số tài khoản: </label>
			                                    <span class="go_sms_product_name popup_billing_info_account_number"></span>
			                                </div> 
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Tên ngân hàng: </label>
			                                	<span class="go_sms_product_name popup_billing_info_bank_name"></span>
			                                </div> 
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Tại tỉnh/thành phố: </label>
			                                	<span class="go_sms_product_name popup_billing_info_city_bank"></span>
			                                </div> 
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Tên chi nhánh: </label>
			                                    <span class="go_sms_product_name popup_billing_info_branch_bank"></span>
			                                </div> 
										</div>
									</fieldset>
								</div>
		...
		<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
                        	...
                        	<textarea id="popup_des_merchant_confirm" name="popup_des_merchant_confirm" title="Nội dung" style="width: 350px;" placeholder="Mô tả/Lý do hủy"  rows="2" maxlength="200"></textarea>
                        </div>
						...
						<div class="product_title">
						    ...
						    Tôi đồng ý thông tin HĐ và tỷ lệ chia sẻ từ 1PAY <span class="popup_detail_profile" style="color:red;"></span>
                        </div>
                        
                        <div class="product_title">
	                        <label class="label_popup_profile"> &nbsp; </label>
	                         	<input type="hidden" class="value_submit_edit_rates" name="submit2" value="approve" />
								<input type="submit" name="approve" value="Xác nhận HĐ" class="btn_greensmall" />
		...
		<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />  
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
							...
							<input type="submit" name="approve" value="Clone profile" class="btn_greensmall" />
							<input name="reset" value="Bỏ qua" class="btn_graysmall modal_close" type="reset">
                        </div>
					...
					$.post($(this).attr('action'), $(this).serialize(), function(json) {
							if (!isNaN(json)) {
								...
								if (x >= 0) {
									...
									if(x == 0){
										mess = 'Clone profile thành công.';
									}else{
										mess = 'Có lỗi clone profile.';
									}
									alert(mess);
            ...
            <form action="<%=request.getContextPath()%>/protected/merchant-profile-ajax.html" method="post" name="preliminary_approve_post">
				...
				<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />
                                ...
                                <div class="product_slc_filter filter_row">
									<fieldset class="identity_verify_popup">
										...
										<div style="padding: 2px;">
			                                ...
			                                <div class="contract_content">     
			                                    <label class="label_popup_edit_contact">Nơi cấp CMND/Địa chỉ ĐKKD<span class="required_red">(*)</span>: </label>
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
                        	<label class="label_popup_profile">Mô tả: </label>
                        	<textarea id="popup_des" class="is_alphanumeric_allow_space" name="popup_des" title="Nội dung" style="width: 350px; height:20px;" placeholder="Mô tả"  rows="2" maxlength="200"></textarea>
                        </div>
                        <div class="product_title">
	                        <label class="label_popup_profile"> &nbsp; </label>
                        ...
                        <div class="product_title">
	                        ...
	                        <label class="lbl_rempass" for="chck_rempass">
								...
								<input type="submit" name="approve" value="Đề xuất HĐ" class="btn_greensmall confirm" />
								<input name="reset" value="Bỏ qua" class="btn_graysmall modal_close" type="reset"/>
	                        </label>
                        </div>
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
	                        ...
	                        <label class="lbl_rempass" for="chck_rempass">
								...
								<input type="submit" name="approve" value="Duyệt HĐ" class="btn_greensmall" />
								<input type="submit" name="reject" value="Hủy duyệt" class="btn_merchant_profile_preview" />
								<input name="reset" value="Bỏ qua" class="btn_graysmall modal_close" type="reset">
	                        </label>
                        </div>
	...
	<form action="<%=request.getContextPath()%>/protected/merchant-profile-ajax.html" method="post" name="offical_post">
		...
		<input type="hidden" id="popup_status" class="popup_status" name="popup_status" value="" />
                    ...
                    <div style="width:670px">
						...
						<div class="product_title">
							<label class="label_popup_profile">Ngày hiệu lực<span style="color: #FF0000; font-weight: normal">(*)</span>: </label>
							<input type="text" id="popup_effective_date" name="popup_effective_date" value="" placeholder="dd/mm/yyyy" class="txt_reglog is_date" maxlength="10" style="width: 100px; " />
							
							(Ví dụ: 28/08/2014)
							<script>
							  $(function() {
								  $('#popup_effective_date').datepicker({
								        dateFormat: "dd/mm/yy",
								        altFormat: "dd/mm/yy"
								  });
							  });
							...
							&nbsp;&nbsp;Giờ: 
							<select name="popup_effective_time" id="popup_effective_time">
								<%
									for(int hour=0;hour<24;hour++){
										String strHour = (hour<10?"0":"")+hour;
								%>
							...
							&nbsp;&nbsp;Phút: 
							<select name="popup_effective_time_minute" id="popup_effective_time_minute">
								<%
									for(int minute=0; minute<60; minute++){
										String strMinute = (minute<10?"0":"")+minute;
								%>
                        ...
                        <div class="product_title">
	                        <label class="label_popup_profile"> &nbsp; </label>
	                         	<input type="hidden" class="value_submit_edit_rates" name="submit2" value="approve" />
								<input type="submit" name="approve" value="Đề xuất tỷ lệ" class="btn_greensmall" />
								<input name="reset" value="Bỏ qua" class="btn_graysmall modal_close" type="reset">
                        </div>
						...
						<script type="text/javascript">
							$(document).ready(function() {
								$('form[name=offical_post] input[type=submit]').live('click', function() {
									...
									if(submit2=='approve'){
										var popup_effective_date = $('#popup_effective_date').val();
										if(popup_effective_date.length==0) {
					    					alert('Xin hãy nhập ngày hiệu lực của profile');
					    					return false;
					    				}
                    ...
                    <div style="width:670px">
                        ...
                        <div class="product_title">
	                        ...
	                        <label class="lbl_rempass" for="chck_rempass">
								...
								<input type="submit" name="approve" value="Duyệt profile" class="btn_greensmall" />
								<input type="submit" name="reject" value="Hủy duyệt" class="btn_merchant_profile_preview" />
								<input name="reset" value="Bỏ qua" class="btn_graysmall modal_close" type="reset">
	                        </label>
                        </div>
...
<!-- /(5)Duyệt profiles -->
	...
	<script type="text/javascript">
		...
		function resetContentPopup()
		{
			...
			//Thông tin thanh toán
			$(".popup_billing_info_account_holder").html("<i>Chưa có</i>");
			$(".popup_billing_info_account_number").html("<i>Chưa có</i>");
			$(".popup_billing_info_bank_name").html("<i>Chưa có</i>");
			$(".popup_billing_info_city_bank").html("<i>Chưa có</i>");
			$(".popup_billing_info_branch_bank").html("<i>Chưa có</i>");
			...
			$(".popup_common_identity__identity").html("<i>Chưa có</i>");
			$(".popup_common_identity_place_of_issue").html("<i>Chưa có</i>");
			$(".popup_common_identity_date_of_issue").html("<i>Chưa có</i>");
			...
			$('.is_date').numeric({allow:"/"});
											...
											$(document).ready(function() {
												...
												$('.duyetsobo').live('click', function() {
													...
													var merchant_desc = $("#hd_merchant_desc-"+pid).val();
													
													//email, phone
													var merchant_email = $("#hd_merchant_email-"+pid).val();
													var merchant_phone = $("#hd_merchant_phone-"+pid).val();
													var merchant_phone_account = $("#hd_merchant_phone_account-"+pid).val();
													
													var active = $('#status_hidden_'+pid).val();
													var paymentPolicy = $('#payment_policy_'+pid).val();
													var contract_type = $('#contract_type_'+pid).val();
													var contract_no = $('#contract_no_'+pid).val();
													var contract_date = $('#contract_date_'+pid).val();
													var rejectLog = '---';
													if($('#rejectLog_'+pid).val()!='' && $('#rejectLog_'+pid).val()!='undefined') rejectLog = $('#rejectLog_'+pid).val();
													...
													var rate_type = $("#hd_using_default-"+pid).val();
													...
													var contract_expired_date = $('#contract_expired_date_'+pid).val();
													...
													//link detail
													$(".popup_link_detail").html("<a href='${pageContext.request.contextPath}/protected/merchant_profile_detail.html?id="+pid+"' style='color:#2C8F39; font-weight:bold;'>Xem chi tiết tỷ lệ ở đây</a>");
													
													//Tự động gia hạn HĐ
													$("#autoExtendedContract_support").attr("checked", true);
													
													var hasHardCopy = $("#hd_hasHardCopy-"+pid).val();
													if(hasHardCopy=='true'){
													...
													var reference=$("#hd_reference-"+pid).val();
													...
													//Thông tin thanh toán
													var paymentInfo = $('#hd_paymentInfo-'+pid).val();
													...
													var effectiveDateFmt = $('#hd_effective_date_fmt-'+pid).val();
													if(effectiveDateFmt!=null){
														$(".popup_effective_date_fmt").html(effectiveDateFmt);
													}else
														$(".popup_effective_date_fmt").html("Chưa có");
													
													//Verify email Status
													var path_image_verrified_phone_email = $("#path_image_verify_phone_email").val();
													var hd_status_verify_email = $("#hd_status_verify_email-"+pid).val();
													...
													//Verify phone Status
													//var hd_verified_phone = $("#hd_verified_phone-"+pid).val();
													var hd_status_verify_phone = $("#hd_status_verify_phone-"+pid).val();
													...
													var popup_reject_log = $('#hd_rejectLog-'+pid).val();
													...
													$.ajax({
												        ...
												        cache: false,
												        url: url_api,
												        data: 'a=billing_infomation&merchant=' + merchant,
												        processData: false,
												        dataType: "json",
												        ...
												        complete: function(){  
												        	...
												        	else
												        	{
																...
																account_holder=dataresponse.account_holder;
																bank_name=dataresponse.bank_name;
																city_bank=dataresponse.city_bank;
																code_bank_name=dataresponse.code_bank_name;
																code_city_bank=dataresponse.code_city_bank;
																branch_bank=dataresponse.branch_bank;
																verify_billing_info=dataresponse.verify;
																//popup values
																$("#popup_account_number").val(dataresponse.account_number);
																$("#popup_account_holder").val(dataresponse.account_holder);
																$("#popup_branch_bank").val(dataresponse.branch_bank);
																$("select#popup_bank_name").val(dataresponse.code_bank_name);
																$("select#popup_city_bank").val(dataresponse.code_city_bank);
																...
																//CMND/DKKD
																identity=dataresponse.identity;
																identityImage=dataresponse.identityImage;
																placeOfIssue=dataresponse.placeOfIssue;
																dateOfIssue=dataresponse.dateOfIssue;
																verify_identity=dataresponse.identity_verify;
																//alert(dataresponse.identity_verify);
																//popup values
																$("#popup_merchant_identity").val(dataresponse.identity);
																$("#popup_place_of_issue").val(dataresponse.placeOfIssue);
																$("#popup_date_of_issue").val(dataresponse.dateOfIssue);
																...
																//Identity
																//var identity = $("#hd_identity-"+pid).val();
																if(identity!=null && identity!='' && identity.length!=0){
																...
																//var hd_identityImage = $("#hd_identityImage-"+pid).val();
													...
													if(active == '0') {
														if(isSupportProfile=='true' && formContractManager!='true'){
															...
															$(".preliminary_approval").trigger("click");
														}
												...
												$('.merchantxacnhan').live('click', function() {
													...
													*/
													...
													//Tự động gia hạn HĐ
													var autoExtendedContract = $("#hd_autoExtendedContract-"+pid).val();
													...
													//Verify email Status
													//var hd_verified_email = $("#hd_verified_email-"+pid).val();
													var path_image_verrified_phone_email = $("#path_image_verify_phone_email").val();
													var hd_status_verify_email = $("#hd_status_verify_email-"+pid).val();
													if(hd_status_verify_email=='true' && hd_status_verify_email!=null && hd_status_verify_email!='' && hd_status_verify_email.length!=0){
														$(".status_verify_email").attr("src",path_image_verrified_phone_email);
													...
													$.ajax({
												        ...
												        complete: function(){  
												        	...
												        	else
												        	{
																...
																//popup values
																$("#popup_review_info_account_number").val(dataresponse.account_number);
																$("#popup_review_info_account_holder").val(dataresponse.account_holder);
																$("#popup_review_info_branch_bank").val(dataresponse.branch_bank);
																$("select#popup_review_info_bank_name").val(dataresponse.code_bank_name);
																$("select#popup_review_info_city_bank").val(dataresponse.code_city_bank);
																...
																//alert(dataresponse.identity_verify);
																//popup values
																$("#popup_review_info_merchant_identity").val(dataresponse.identity);
																$("#popup_review_info_place_of_issue").val(dataresponse.placeOfIssue);
																$("#popup_review_info_date_of_issue").val(dataresponse.dateOfIssue);
													...
													if(active == '2') {
														if(isReviewProfileInfo=='true'){
															...
															$(".merchant_approval").trigger("click");
														}
														else $(".common_contract_infomations_popup").trigger("click");
													}else
													{
												...
												$('.duyetchinhthuc').live('click', function() {
													...
													$(".popup_detail_profile").html('<a class="slc_link" href="<%=request.getContextPath()%>/protected/merchant_profile_detail.html?id='+pid+'" style="color:red" target="_blank">Xem chi tiết tỷ lệ ở đây</a>');
													...
													*/
													...
													if(active == '4') {
														...
														if(isPromoteRate=='true')$(".offical_approval").trigger("click");
														else $(".common_contract_infomations_popup").trigger("click");
													}else
													{
														$(".common_contract_infomations_popup").trigger("click");
												...
												$('.merchant_xacnhan_hd').live('click', function() {
													...
													*/
													...
													var hd_status_verify_billing_info = $("#hd_status_verify_billing_info-"+pid).val();
															...
															**/
															if(account==merchant)
															{
																...
																if(hd_status_verify_email=='true' && hd_status_verify_phone=='true' && hd_status_verify_billing_info=='true')
																	$(".merchant_confirm-contract").trigger("click");
																else
												...
												$('.thanhtoan').live('click', function() {
													...
													*/
													...
													if(active == '8') {
														if(isReviewProfileRate=='true')$(".billing_approval").trigger("click");
														else $(".common_contract_infomations_popup").trigger("click");
													}else
													{
														$(".common_contract_infomations_popup").trigger("click");
