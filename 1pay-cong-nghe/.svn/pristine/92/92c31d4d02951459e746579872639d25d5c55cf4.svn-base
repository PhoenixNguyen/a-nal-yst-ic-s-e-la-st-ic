...
#add_edit_popup .item label{
  display: block;
  padding: 5px;
  width: 90%;
}
#add_edit_popup .item input{
  padding: 5px;
  width: 90%;
}

#add_edit_popup .item textarea{
  padding: 5px;
  width: 90%;
}

#add_edit_popup .item select{
  padding: 5px;
  width: 50%;
}

#add_edit_popup .decision input{
  padding: 5px;
  width: 20%;
}
...
#detail_popup .item span{
	float: right;
	width: 70%;
}

#add_edit_popup .decision{
  padding: 5px;
  width: 90%;
}
