...
<%@page import="org.hibernate.cache.jbc2.builder.SharedCacheInstanceManager"%>
...
<%
	LinkedHashMap ALL_CHARGING_STATUS_EN = new LinkedHashMap();
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.NOT_AVAIABLE_STATUS), "No contracted electronic");
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.APPROVED_PENDING_STATUS), "1PAY approve");
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.APPROVED_STATUS), "Approved");
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.REJECT_STATUS), "Rejected");
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.PENDING_STATUS), "Proposed");
	ALL_CHARGING_STATUS_EN.put(SharedConstants.ALL_CHARGING_STATUS.get(MerchantProduct.INIT_STATUS), "Have contracted electronic");
	
	request.setAttribute("ALL_CHARGING_STATUS_EN", ALL_CHARGING_STATUS_EN);
%>