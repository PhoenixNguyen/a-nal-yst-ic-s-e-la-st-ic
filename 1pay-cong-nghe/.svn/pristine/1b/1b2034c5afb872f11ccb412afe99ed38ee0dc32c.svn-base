						...
						<div class="right_content">
							...
							<div>
								<form id="cardSandBox" action="card-sand-box.html" method="post">
									<div id="dash_tab">
											<a id="cont" href="<%=request.getContextPath() %>/protected/card-sand-box.html" class="tab_slc"><span>Card Charing</span></a> 
											<a id="telco" href="<%=request.getContextPath() %>/protected/sms-sand-box.html" class="tab"><span>SMS Charing</span></a> 
											<a id="price" href="<%=request.getContextPath() %>/protected/wap-sand-box.html" class="tab"><span>WAP Charing</span></a>
											<div class="clear"></div>
									</div>
									<div id="filter_locketqua">
										<!-- .widget-header -->
										<form:form name="cardSandBox" commandName="cardSandBox" method="post">
										<div>
											...
											<div class="filter_row">
							                 	<span class="add-on">Card Serial:</span>
							               		<form:input path="serial"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
							                 	<span class="add-on">Card Pin:</span>
							               		<form:input path="pin"  class="txt_filter"/>
							                </div>
							                <div class="filter_row">
										...
										<!-- .widget-content -->
										<c:if test="${ cardSandBox.signature!=null && cardSandBox.signature!=''}">
											<h3>Kết quả</h3>
											<div>
											<div class="filter_row">
