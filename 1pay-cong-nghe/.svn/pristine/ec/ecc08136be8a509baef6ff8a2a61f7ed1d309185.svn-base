											...
											<div class="filter_row">
								                ...
								                <div style="display: block;float: right;">
								                 	...
								                 	<select id="status" name="status" class="dashboard_filter">
								                 		...
								                 		<option value="0" ${(param.status == '0')?'selected="selected"':''}>0-Đối soát khởi tạo</option>
								                 		<option value="1" ${(param.status == '1')?'selected="selected"':''}>1-Hủy đề nghị duyệt đối soát</option>
								                 		<option value="2" ${(param.status == '2')?'selected="selected"':''}>2-Chờ duyệt đối soát</option>
								                 		<option value="3" ${(param.status == '3')?'selected="selected"':''}>3-Bị hủy duyệt đối soát</option>
								                 		<option value="4" ${(param.status == '4')?'selected="selected"':''}>4-Chờ provider xác nhận đối soát</option>
								                 		<option value="5" ${(param.status == '5')?'selected="selected"':''}>5-Provider hủy xác nhận đối soát</option>
								                 		<option value="6" ${(param.status == '6')?'selected="selected"':''}>6-Chờ provider xác nhận hoàn thành thanh toán</option>
								                 		<option value="7" ${(param.status == '7')?'selected="selected"':''}>7-Provider hủy xác nhận hoàn thành thanh toán</option>
								                 		<option value="8" ${(param.status == '8')?'selected="selected"':''}>8-Chờ 1Pay xác nhận được thanh toán</option>
								                 		<option value="9" ${(param.status == '9')?'selected="selected"':''}>9-1Pay hủy xác nhận được thanh toán</option>
								                 		<option value="10" ${(param.status == '10')?'selected="selected"':''}>10-1Pay xác nhận được thanh toán</option>
								                 	</select>
								                </div>
								                </c:if>
							                </div>
							                ...
							                <div class="filter_row">
							                	<span class="add-on" style="padding-left:40px; display:block; width:100px;">Chu kỳ đối soát:</span>
							                 	<select id="paymentPolicy" name="paymentPolicy" class="dashboard_filter">
							                 		...
							                 		<option value="15_1_1" ${(param.paymentPolicy == '15_1_1')?'selected="selected"':''}>15+1 (Kỳ I)</option>
							                 		<option value="15_1_2" ${(param.paymentPolicy == '15_1_2')?'selected="selected"':''}>15+1 (Kỳ II)</option>
