				...
				<div id="w_body">
					<div class="row_sub">
						...
						<div class="right_content">
							<h1 class="srv_title">Phone confirmation</h1>
							<c:if test="${!model.verify_phone}">
								<div class="srv_row">
									<label class="lbl_moi">Step 1:</label> Enter your cell phone number.
								</div>
							</c:if>
									...
									<div class="form_row">
										<c:choose>
											<c:when test="${!model.verify_phone && model.phone!=null }">
												<input type="text" name="phone" class="txt_reglog is_numeric" title="Phone number" value="${model.phone }" placeholder="Phone number" onfocus="clear(this)" maxlength="14"/>
											</c:when>
											<c:when test="${!model.verify_phone && model.phone==null }">
												<input type="text" name="phone" class="txt_reglog is_numeric" title="Phone number" placeholder="Phone number" onfocus="clear(this)" maxlength="14"/>
											</c:when>
											<c:otherwise>
												<div class="form_row">
													Phone number: 
													<span id="actived.errors" style="color:#39B54A;">
														...
														<img src="/1pay/images/tick.png" alt="Phone number validated"/>
													</span>
												</div>
											</c:otherwise>
										</c:choose>
