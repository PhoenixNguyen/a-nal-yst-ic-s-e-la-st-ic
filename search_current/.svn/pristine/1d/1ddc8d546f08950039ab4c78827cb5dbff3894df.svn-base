...
public class ChargeStatus {
	...
	public static Map<String,String> MAP_STATUS_MESSAGE = new HashMap<String, String>();
	static{
	...
	public final static List<String> ALL_CHARGING_SUCCESS_STATUS= Arrays.asList(new String[]{
			ChargeStatus.SUCCESS_STATUS,
	});
	
	public final static List<String> ALL_CHARGING_INVALID_CARD_STATUS= Arrays.asList(new String[]{
			ChargeStatus.CARD_IS_USED_OR_NOT_EXISTED_STATUS,//Thẻ đã được sử dụng, hoặc thẻ sai.
			ChargeStatus.CARD_LOCKED_STATUS, //Thẻ bị khóa
			ChargeStatus.CARD_EXPIRED_STATUS, //Thẻ hết hạn sử dụng.
			ChargeStatus.CARD_NOT_ACTIVED_OR_NOT_EXISTED_STATUS, //Thẻ chưa được kích hoạt hoặc không tồn tại.
			ChargeStatus.CARD_PIN_FORMAT_INCORRECT_STATUS, //Mã thẻ sai định dạng.
			ChargeStatus.CARD_SERIAL_INVALID_STATUS, //Sai số serial của thẻ.
			ChargeStatus.CARD_SERIAL_AND_PIN_NOT_MATCH_STATUS, //Mã thẻ và số serial không khớp.
			ChargeStatus.CARD_NOT_EXISTED_STATUS, //"Thẻ không tồn tại"
			ChargeStatus.CARD_CAN_NOT_BE_USED_STATUS, //"Thẻ không sử dụng được."
	});
	...
	public final static List<String> ALL_CHARGING_INVALID_STATUS = Arrays
			.asList(new String[] { 
