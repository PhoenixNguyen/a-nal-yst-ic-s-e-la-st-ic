...
public class CardCdrController extends AbstractProtectedController{
  ...
  protected ModelAndView handleRequest(HttpServletRequest request,
    ...
    List<String> timeRanges = Arrays.asList(new String[]{df.format(CardChargingMaintenanceCalendarController.handleDate(fromDateStr, false)), 
        df.format(CardChargingMaintenanceCalendarController.handleDate(toDateStr, true))});
    ...
    int page = 0;
      ...
      //List Object
        List<ESCardCdr> cardCdrList = new ArrayList<ESCardCdr>();
        //Count
        int count = 0;
        ...
        if(elasticSearchService.checkIndex(ESCardCdr.class)){
            ...
            cardCdrList = elasticSearchService.search(fields, terms, keywords, sorts, page, limit, facetSize, ESCardCdr.class);
        }
