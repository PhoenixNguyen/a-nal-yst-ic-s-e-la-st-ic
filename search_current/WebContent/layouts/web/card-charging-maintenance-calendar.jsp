                ...
                <div id="w_body">
                    <div class="row_sub">
                        ...
                        <div class="right_content">
                            <h1 class="srv_title">Lịch bảo trì thẻ</h1>
                            <!-- Filter -->
                            ...
                            <form action="card-maintenance-calendar.html" method="get" name="filter_result">
                            ...
                            <display:table name="model.list" id="list"
                                requestURI="card-maintenance-calendar.html" partialList="true" size="model.total" pagesize="${model.pagesize}"
                            ...
                            <script type="text/javascript">
                              ...
                              $(document).ready(function(){
                            	...
                            	$('.delete_record').live('click', function(){
                            		...
                            		$.ajax({
                                        type : "post",
                                        url : 'card-maintenance-calendar-ajax.html',
                            ...
                            <div id="add_record_popup">
                                <form action="card-maintenance-calendar-ajax.html" method="post" name="add_edit">
                                    <input type="hidden" name="action" value="ADD_EDIT"/>
                                    <input type="hidden" name="id" value=""/>
                                    
	                                <h2 class=""><span class="update_status">Lịch bảo trì thẻ</span></h2>
	                                <div class="item">
					                    <label>Tiêu đề: </label>
